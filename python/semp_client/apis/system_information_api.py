...
class SystemInformationApi(object):
    ...
    def get_system_information(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_system_information(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.get_system_information_with_http_info(**kwargs)
        else:
            (data) = self.get_system_information_with_http_info(**kwargs)
            return data

    def get_system_information_with_http_info(self, **kwargs):
        """
        Gets SEMP API version and platform information.
        Gets SEMP API version and platform information.  A SEMP client authorized with a minimum access scope/level of \"global/none\" is required to perform this operation.  This has been available since 2.1.0.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_system_information_with_http_info(callback=callback_function)
        ...
        resource_path = '/systemInformation'.replace('{format}', 'json')
        path_params = {}
