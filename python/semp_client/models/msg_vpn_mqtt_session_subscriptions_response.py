...
class MsgVpnMqttSessionSubscriptionsResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnMqttSessionSubscriptionsResponse - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'data': 'list[MsgVpnMqttSessionSubscription]',
            'links': 'list[MsgVpnMqttSessionSubscriptionLinks]',
            'meta': 'SempMeta'
        }
    ...
    def data(self):
        """
        Gets the data of this MsgVpnMqttSessionSubscriptionsResponse.


        :return: The data of this MsgVpnMqttSessionSubscriptionsResponse.
        :rtype: list[MsgVpnMqttSessionSubscription]
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnMqttSessionSubscriptionsResponse.


        :param data: The data of this MsgVpnMqttSessionSubscriptionsResponse.
        :type: list[MsgVpnMqttSessionSubscription]
        """
    ...
    def links(self):
        """
        Gets the links of this MsgVpnMqttSessionSubscriptionsResponse.


        :return: The links of this MsgVpnMqttSessionSubscriptionsResponse.
        :rtype: list[MsgVpnMqttSessionSubscriptionLinks]
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnMqttSessionSubscriptionsResponse.


        :param links: The links of this MsgVpnMqttSessionSubscriptionsResponse.
        :type: list[MsgVpnMqttSessionSubscriptionLinks]
        """
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnMqttSessionSubscriptionsResponse.


        :return: The meta of this MsgVpnMqttSessionSubscriptionsResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnMqttSessionSubscriptionsResponse.


        :param meta: The meta of this MsgVpnMqttSessionSubscriptionsResponse.
        :type: SempMeta
        """
