...
class MsgVpnRestDeliveryPointRestConsumersResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnRestDeliveryPointRestConsumersResponse - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'data': 'list[MsgVpnRestDeliveryPointRestConsumer]',
            'links': 'list[MsgVpnRestDeliveryPointRestConsumerLinks]',
            'meta': 'SempMeta'
        }
    ...
    def data(self):
        """
        Gets the data of this MsgVpnRestDeliveryPointRestConsumersResponse.


        :return: The data of this MsgVpnRestDeliveryPointRestConsumersResponse.
        :rtype: list[MsgVpnRestDeliveryPointRestConsumer]
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnRestDeliveryPointRestConsumersResponse.


        :param data: The data of this MsgVpnRestDeliveryPointRestConsumersResponse.
        :type: list[MsgVpnRestDeliveryPointRestConsumer]
        """
    ...
    def links(self):
        """
        Gets the links of this MsgVpnRestDeliveryPointRestConsumersResponse.


        :return: The links of this MsgVpnRestDeliveryPointRestConsumersResponse.
        :rtype: list[MsgVpnRestDeliveryPointRestConsumerLinks]
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnRestDeliveryPointRestConsumersResponse.


        :param links: The links of this MsgVpnRestDeliveryPointRestConsumersResponse.
        :type: list[MsgVpnRestDeliveryPointRestConsumerLinks]
        """
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnRestDeliveryPointRestConsumersResponse.


        :return: The meta of this MsgVpnRestDeliveryPointRestConsumersResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnRestDeliveryPointRestConsumersResponse.


        :param meta: The meta of this MsgVpnRestDeliveryPointRestConsumersResponse.
        :type: SempMeta
        """
