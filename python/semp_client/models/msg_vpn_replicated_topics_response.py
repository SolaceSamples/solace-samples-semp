...
class MsgVpnReplicatedTopicsResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnReplicatedTopicsResponse - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'data': 'list[MsgVpnReplicatedTopic]',
            'links': 'list[MsgVpnReplicatedTopicLinks]',
            'meta': 'SempMeta'
        }
    ...
    def data(self):
        """
        Gets the data of this MsgVpnReplicatedTopicsResponse.


        :return: The data of this MsgVpnReplicatedTopicsResponse.
        :rtype: list[MsgVpnReplicatedTopic]
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnReplicatedTopicsResponse.


        :param data: The data of this MsgVpnReplicatedTopicsResponse.
        :type: list[MsgVpnReplicatedTopic]
        """
    ...
    def links(self):
        """
        Gets the links of this MsgVpnReplicatedTopicsResponse.


        :return: The links of this MsgVpnReplicatedTopicsResponse.
        :rtype: list[MsgVpnReplicatedTopicLinks]
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnReplicatedTopicsResponse.


        :param links: The links of this MsgVpnReplicatedTopicsResponse.
        :type: list[MsgVpnReplicatedTopicLinks]
        """
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnReplicatedTopicsResponse.


        :return: The meta of this MsgVpnReplicatedTopicsResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnReplicatedTopicsResponse.


        :param meta: The meta of this MsgVpnReplicatedTopicsResponse.
        :type: SempMeta
        """
