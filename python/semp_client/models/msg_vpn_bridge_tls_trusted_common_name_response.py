...
class MsgVpnBridgeTlsTrustedCommonNameResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnBridgeTlsTrustedCommonNameResponse - a model defined in Swagger
    ...
    def data(self):
        """
        Gets the data of this MsgVpnBridgeTlsTrustedCommonNameResponse.


        :return: The data of this MsgVpnBridgeTlsTrustedCommonNameResponse.
        :rtype: MsgVpnBridgeTlsTrustedCommonName
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnBridgeTlsTrustedCommonNameResponse.


        :param data: The data of this MsgVpnBridgeTlsTrustedCommonNameResponse.
    ...
    def links(self):
        """
        Gets the links of this MsgVpnBridgeTlsTrustedCommonNameResponse.


        :return: The links of this MsgVpnBridgeTlsTrustedCommonNameResponse.
        :rtype: MsgVpnBridgeTlsTrustedCommonNameLinks
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnBridgeTlsTrustedCommonNameResponse.


        :param links: The links of this MsgVpnBridgeTlsTrustedCommonNameResponse.
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnBridgeTlsTrustedCommonNameResponse.


        :return: The meta of this MsgVpnBridgeTlsTrustedCommonNameResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnBridgeTlsTrustedCommonNameResponse.


        :param meta: The meta of this MsgVpnBridgeTlsTrustedCommonNameResponse.
        :type: SempMeta
        """
