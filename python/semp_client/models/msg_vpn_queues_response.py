...
class MsgVpnQueuesResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnQueuesResponse - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'data': 'list[MsgVpnQueue]',
            'links': 'list[MsgVpnQueueLinks]',
            'meta': 'SempMeta'
        }
    ...
    def data(self):
        """
        Gets the data of this MsgVpnQueuesResponse.


        :return: The data of this MsgVpnQueuesResponse.
        :rtype: list[MsgVpnQueue]
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnQueuesResponse.


        :param data: The data of this MsgVpnQueuesResponse.
        :type: list[MsgVpnQueue]
        """
    ...
    def links(self):
        """
        Gets the links of this MsgVpnQueuesResponse.


        :return: The links of this MsgVpnQueuesResponse.
        :rtype: list[MsgVpnQueueLinks]
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnQueuesResponse.


        :param links: The links of this MsgVpnQueuesResponse.
        :type: list[MsgVpnQueueLinks]
        """
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnQueuesResponse.


        :return: The meta of this MsgVpnQueuesResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnQueuesResponse.


        :param meta: The meta of this MsgVpnQueuesResponse.
        :type: SempMeta
        """
