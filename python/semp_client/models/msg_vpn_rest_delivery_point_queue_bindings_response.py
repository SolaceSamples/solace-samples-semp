...
class MsgVpnRestDeliveryPointQueueBindingsResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnRestDeliveryPointQueueBindingsResponse - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'data': 'list[MsgVpnRestDeliveryPointQueueBinding]',
            'links': 'list[MsgVpnRestDeliveryPointQueueBindingLinks]',
            'meta': 'SempMeta'
        }
    ...
    def data(self):
        """
        Gets the data of this MsgVpnRestDeliveryPointQueueBindingsResponse.


        :return: The data of this MsgVpnRestDeliveryPointQueueBindingsResponse.
        :rtype: list[MsgVpnRestDeliveryPointQueueBinding]
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnRestDeliveryPointQueueBindingsResponse.


        :param data: The data of this MsgVpnRestDeliveryPointQueueBindingsResponse.
        :type: list[MsgVpnRestDeliveryPointQueueBinding]
        """
    ...
    def links(self):
        """
        Gets the links of this MsgVpnRestDeliveryPointQueueBindingsResponse.


        :return: The links of this MsgVpnRestDeliveryPointQueueBindingsResponse.
        :rtype: list[MsgVpnRestDeliveryPointQueueBindingLinks]
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnRestDeliveryPointQueueBindingsResponse.


        :param links: The links of this MsgVpnRestDeliveryPointQueueBindingsResponse.
        :type: list[MsgVpnRestDeliveryPointQueueBindingLinks]
        """
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnRestDeliveryPointQueueBindingsResponse.


        :return: The meta of this MsgVpnRestDeliveryPointQueueBindingsResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnRestDeliveryPointQueueBindingsResponse.


        :param meta: The meta of this MsgVpnRestDeliveryPointQueueBindingsResponse.
        :type: SempMeta
        """
