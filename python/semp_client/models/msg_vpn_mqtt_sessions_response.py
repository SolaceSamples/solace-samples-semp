...
class MsgVpnMqttSessionsResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnMqttSessionsResponse - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'data': 'list[MsgVpnMqttSession]',
            'links': 'list[MsgVpnMqttSessionLinks]',
            'meta': 'SempMeta'
        }
    ...
    def data(self):
        """
        Gets the data of this MsgVpnMqttSessionsResponse.


        :return: The data of this MsgVpnMqttSessionsResponse.
        :rtype: list[MsgVpnMqttSession]
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnMqttSessionsResponse.


        :param data: The data of this MsgVpnMqttSessionsResponse.
        :type: list[MsgVpnMqttSession]
        """
    ...
    def links(self):
        """
        Gets the links of this MsgVpnMqttSessionsResponse.


        :return: The links of this MsgVpnMqttSessionsResponse.
        :rtype: list[MsgVpnMqttSessionLinks]
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnMqttSessionsResponse.


        :param links: The links of this MsgVpnMqttSessionsResponse.
        :type: list[MsgVpnMqttSessionLinks]
        """
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnMqttSessionsResponse.


        :return: The meta of this MsgVpnMqttSessionsResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnMqttSessionsResponse.


        :param meta: The meta of this MsgVpnMqttSessionsResponse.
        :type: SempMeta
        """
