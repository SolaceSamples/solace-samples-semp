...
class MsgVpnAclProfileSubscribeException(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, acl_profile_name=None, msg_vpn_name=None, subscribe_exception_topic=None, topic_syntax=None):
        """
        MsgVpnAclProfileSubscribeException - a model defined in Swagger
        ...
        self.attribute_map = {
            ...
            'subscribe_exception_topic': 'subscribeExceptionTopic',
            'topic_syntax': 'topicSyntax'
        }

        self._acl_profile_name = acl_profile_name
        self._msg_vpn_name = msg_vpn_name
        self._subscribe_exception_topic = subscribe_exception_topic
        self._topic_syntax = topic_syntax

    @property
    def acl_profile_name(self):
        """
        Gets the acl_profile_name of this MsgVpnAclProfileSubscribeException.
        The name of the ACL Profile.

        :return: The acl_profile_name of this MsgVpnAclProfileSubscribeException.
        :rtype: str
        """
    ...
    def acl_profile_name(self, acl_profile_name):
        """
        Sets the acl_profile_name of this MsgVpnAclProfileSubscribeException.
        The name of the ACL Profile.

        :param acl_profile_name: The acl_profile_name of this MsgVpnAclProfileSubscribeException.
        :type: str
        """
    ...
    def msg_vpn_name(self):
        """
        Gets the msg_vpn_name of this MsgVpnAclProfileSubscribeException.
        The name of the Message VPN.

        :return: The msg_vpn_name of this MsgVpnAclProfileSubscribeException.
        :rtype: str
        """
    ...
    def msg_vpn_name(self, msg_vpn_name):
        """
        Sets the msg_vpn_name of this MsgVpnAclProfileSubscribeException.
        The name of the Message VPN.

        :param msg_vpn_name: The msg_vpn_name of this MsgVpnAclProfileSubscribeException.
        :type: str
        """
    ...
    @property
    def subscribe_exception_topic(self):
        """
        Gets the subscribe_exception_topic of this MsgVpnAclProfileSubscribeException.
        The topic of the Exception. May include syntax-appropriate wildcards.

        :return: The subscribe_exception_topic of this MsgVpnAclProfileSubscribeException.
        :rtype: str
        """
        return self._subscribe_exception_topic

    @subscribe_exception_topic.setter
    def subscribe_exception_topic(self, subscribe_exception_topic):
        """
        Sets the subscribe_exception_topic of this MsgVpnAclProfileSubscribeException.
        The topic of the Exception. May include syntax-appropriate wildcards.

        :param subscribe_exception_topic: The subscribe_exception_topic of this MsgVpnAclProfileSubscribeException.
        :type: str
        """
    ...
    @property
    def topic_syntax(self):
        """
        Gets the topic_syntax of this MsgVpnAclProfileSubscribeException.
        The syntax of the topic of the Exception. The allowed values and their meaning are:      \"smf\" - Topic uses SMF syntax.     \"mqtt\" - Topic uses MQTT syntax. 

        :return: The topic_syntax of this MsgVpnAclProfileSubscribeException.
        :rtype: str
        """
        return self._topic_syntax

    @topic_syntax.setter
    def topic_syntax(self, topic_syntax):
        """
        Sets the topic_syntax of this MsgVpnAclProfileSubscribeException.
        The syntax of the topic of the Exception. The allowed values and their meaning are:      \"smf\" - Topic uses SMF syntax.     \"mqtt\" - Topic uses MQTT syntax. 

        :param topic_syntax: The topic_syntax of this MsgVpnAclProfileSubscribeException.
        :type: str
        """
        allowed_values = ["smf", "mqtt"]
        if topic_syntax not in allowed_values:
            raise ValueError(
                "Invalid value for `topic_syntax` ({0}), must be one of {1}"
                .format(topic_syntax, allowed_values)
            )
