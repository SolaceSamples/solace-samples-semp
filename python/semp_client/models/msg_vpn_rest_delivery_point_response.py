...
class MsgVpnRestDeliveryPointResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnRestDeliveryPointResponse - a model defined in Swagger
    ...
    def data(self):
        """
        Gets the data of this MsgVpnRestDeliveryPointResponse.


        :return: The data of this MsgVpnRestDeliveryPointResponse.
        :rtype: MsgVpnRestDeliveryPoint
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnRestDeliveryPointResponse.


        :param data: The data of this MsgVpnRestDeliveryPointResponse.
    ...
    def links(self):
        """
        Gets the links of this MsgVpnRestDeliveryPointResponse.


        :return: The links of this MsgVpnRestDeliveryPointResponse.
        :rtype: MsgVpnRestDeliveryPointLinks
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnRestDeliveryPointResponse.


        :param links: The links of this MsgVpnRestDeliveryPointResponse.
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnRestDeliveryPointResponse.


        :return: The meta of this MsgVpnRestDeliveryPointResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnRestDeliveryPointResponse.


        :param meta: The meta of this MsgVpnRestDeliveryPointResponse.
        :type: SempMeta
        """
