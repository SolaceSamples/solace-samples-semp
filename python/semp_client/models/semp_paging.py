...
class SempPaging(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, cursor_query=None, next_page_uri=None):
        """
        SempPaging - a model defined in Swagger
        ...
        self._cursor_query = cursor_query
        self._next_page_uri = next_page_uri

    @property
    def cursor_query(self):
        """
        Gets the cursor_query of this SempPaging.
        The cursor, or position, for the next page of objects. Use this as the `cursor` query parameter of the next request.

        :return: The cursor_query of this SempPaging.
        :rtype: str
        """
        return self._cursor_query

    @cursor_query.setter
    def cursor_query(self, cursor_query):
        """
        Sets the cursor_query of this SempPaging.
        The cursor, or position, for the next page of objects. Use this as the `cursor` query parameter of the next request.

        :param cursor_query: The cursor_query of this SempPaging.
        :type: str
        """
    ...
    def next_page_uri(self):
        """
        Gets the next_page_uri of this SempPaging.
        The URI of the next page of objects. `cursorQuery` is already embedded within this URI.

        :return: The next_page_uri of this SempPaging.
        :rtype: str
        """
    ...
    def next_page_uri(self, next_page_uri):
        """
        Sets the next_page_uri of this SempPaging.
        The URI of the next page of objects. `cursorQuery` is already embedded within this URI.

        :param next_page_uri: The next_page_uri of this SempPaging.
        :type: str
        """
