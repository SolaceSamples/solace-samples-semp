...
class MsgVpnBridgeRemoteSubscriptionResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnBridgeRemoteSubscriptionResponse - a model defined in Swagger
    ...
    def data(self):
        """
        Gets the data of this MsgVpnBridgeRemoteSubscriptionResponse.


        :return: The data of this MsgVpnBridgeRemoteSubscriptionResponse.
        :rtype: MsgVpnBridgeRemoteSubscription
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnBridgeRemoteSubscriptionResponse.


        :param data: The data of this MsgVpnBridgeRemoteSubscriptionResponse.
    ...
    def links(self):
        """
        Gets the links of this MsgVpnBridgeRemoteSubscriptionResponse.


        :return: The links of this MsgVpnBridgeRemoteSubscriptionResponse.
        :rtype: MsgVpnBridgeRemoteSubscriptionLinks
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnBridgeRemoteSubscriptionResponse.


        :param links: The links of this MsgVpnBridgeRemoteSubscriptionResponse.
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnBridgeRemoteSubscriptionResponse.


        :return: The meta of this MsgVpnBridgeRemoteSubscriptionResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnBridgeRemoteSubscriptionResponse.


        :param meta: The meta of this MsgVpnBridgeRemoteSubscriptionResponse.
        :type: SempMeta
        """
