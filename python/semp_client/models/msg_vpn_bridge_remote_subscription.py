...
class MsgVpnBridgeRemoteSubscription(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, bridge_name=None, bridge_virtual_router=None, deliver_always_enabled=None, msg_vpn_name=None, remote_subscription_topic=None):
        """
        MsgVpnBridgeRemoteSubscription - a model defined in Swagger
        ...
        self.swagger_types = {
            ...
            'deliver_always_enabled': 'bool',
            'msg_vpn_name': 'str',
            'remote_subscription_topic': 'str'
        }

        self.attribute_map = {
            'bridge_name': 'bridgeName',
            'bridge_virtual_router': 'bridgeVirtualRouter',
            'deliver_always_enabled': 'deliverAlwaysEnabled',
            'msg_vpn_name': 'msgVpnName',
            'remote_subscription_topic': 'remoteSubscriptionTopic'
        }

        self._bridge_name = bridge_name
        self._bridge_virtual_router = bridge_virtual_router
        self._deliver_always_enabled = deliver_always_enabled
        self._msg_vpn_name = msg_vpn_name
        self._remote_subscription_topic = remote_subscription_topic

    @property
    def bridge_name(self):
        """
        Gets the bridge_name of this MsgVpnBridgeRemoteSubscription.
        The name of the Bridge.

        :return: The bridge_name of this MsgVpnBridgeRemoteSubscription.
        :rtype: str
        """
    ...
    def bridge_name(self, bridge_name):
        """
        Sets the bridge_name of this MsgVpnBridgeRemoteSubscription.
        The name of the Bridge.

        :param bridge_name: The bridge_name of this MsgVpnBridgeRemoteSubscription.
        :type: str
        """
    ...
    def bridge_virtual_router(self):
        """
        Gets the bridge_virtual_router of this MsgVpnBridgeRemoteSubscription.
        ...
        :return: The bridge_virtual_router of this MsgVpnBridgeRemoteSubscription.
        :rtype: str
        """
    ...
    def bridge_virtual_router(self, bridge_virtual_router):
        """
        Sets the bridge_virtual_router of this MsgVpnBridgeRemoteSubscription.
        The virtual-router of the Bridge. The allowed values and their meaning are:      \"primary\" - Bridge belongs to the primary virtual-router.     \"backup\" - Bridge belongs to the backup virtual-router. 

        :param bridge_virtual_router: The bridge_virtual_router of this MsgVpnBridgeRemoteSubscription.
        :type: str
        """
    ...
    @property
    def deliver_always_enabled(self):
        """
        Gets the deliver_always_enabled of this MsgVpnBridgeRemoteSubscription.
        ...
        :return: The deliver_always_enabled of this MsgVpnBridgeRemoteSubscription.
        :rtype: bool
        """
        return self._deliver_always_enabled

    @deliver_always_enabled.setter
    def deliver_always_enabled(self, deliver_always_enabled):
        """
        Sets the deliver_always_enabled of this MsgVpnBridgeRemoteSubscription.
        Flag the topic as deliver-always instead of with the configured deliver-to-one remote-priority value for the bridge. A given topic may be deliver-to-one or deliver-always but not both.

        :param deliver_always_enabled: The deliver_always_enabled of this MsgVpnBridgeRemoteSubscription.
        :type: bool
        """
    ...
    def msg_vpn_name(self):
        """
        Gets the msg_vpn_name of this MsgVpnBridgeRemoteSubscription.
        The name of the Message VPN.

        :return: The msg_vpn_name of this MsgVpnBridgeRemoteSubscription.
        :rtype: str
        """
    ...
    def msg_vpn_name(self, msg_vpn_name):
        """
        Sets the msg_vpn_name of this MsgVpnBridgeRemoteSubscription.
        The name of the Message VPN.

        :param msg_vpn_name: The msg_vpn_name of this MsgVpnBridgeRemoteSubscription.
        :type: str
        """
    ...
    @property
    def remote_subscription_topic(self):
        """
        Gets the remote_subscription_topic of this MsgVpnBridgeRemoteSubscription.
        The topic of the Remote Subscription.

        :return: The remote_subscription_topic of this MsgVpnBridgeRemoteSubscription.
        :rtype: str
        """
        return self._remote_subscription_topic

    @remote_subscription_topic.setter
    def remote_subscription_topic(self, remote_subscription_topic):
        """
        Sets the remote_subscription_topic of this MsgVpnBridgeRemoteSubscription.
        The topic of the Remote Subscription.

        :param remote_subscription_topic: The remote_subscription_topic of this MsgVpnBridgeRemoteSubscription.
        :type: str
        """
