...
class MsgVpnsResponse(object):
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnsResponse - a model defined in Swagger
    ...
    def data(self):
        """
        Gets the data of this MsgVpnsResponse.


        :return: The data of this MsgVpnsResponse.
        :rtype: list[MsgVpn]
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnsResponse.


        :param data: The data of this MsgVpnsResponse.
        :type: list[MsgVpn]
        """
    ...
    def links(self):
        """
        Gets the links of this MsgVpnsResponse.


        :return: The links of this MsgVpnsResponse.
        :rtype: list[MsgVpnLinks]
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnsResponse.


        :param links: The links of this MsgVpnsResponse.
        :type: list[MsgVpnLinks]
        """
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnsResponse.


        :return: The meta of this MsgVpnsResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnsResponse.


        :param meta: The meta of this MsgVpnsResponse.
        :type: SempMeta
        """
