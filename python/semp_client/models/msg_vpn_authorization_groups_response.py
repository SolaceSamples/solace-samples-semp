...
class MsgVpnAuthorizationGroupsResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnAuthorizationGroupsResponse - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'data': 'list[MsgVpnAuthorizationGroup]',
            'links': 'list[MsgVpnAuthorizationGroupLinks]',
            'meta': 'SempMeta'
        }
    ...
    def data(self):
        """
        Gets the data of this MsgVpnAuthorizationGroupsResponse.


        :return: The data of this MsgVpnAuthorizationGroupsResponse.
        :rtype: list[MsgVpnAuthorizationGroup]
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnAuthorizationGroupsResponse.


        :param data: The data of this MsgVpnAuthorizationGroupsResponse.
        :type: list[MsgVpnAuthorizationGroup]
        """
    ...
    def links(self):
        """
        Gets the links of this MsgVpnAuthorizationGroupsResponse.


        :return: The links of this MsgVpnAuthorizationGroupsResponse.
        :rtype: list[MsgVpnAuthorizationGroupLinks]
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnAuthorizationGroupsResponse.


        :param links: The links of this MsgVpnAuthorizationGroupsResponse.
        :type: list[MsgVpnAuthorizationGroupLinks]
        """
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnAuthorizationGroupsResponse.


        :return: The meta of this MsgVpnAuthorizationGroupsResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnAuthorizationGroupsResponse.


        :param meta: The meta of this MsgVpnAuthorizationGroupsResponse.
        :type: SempMeta
        """
