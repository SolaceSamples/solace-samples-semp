...
class MsgVpnAclProfileLinks(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, client_connect_exceptions_uri=None, publish_exceptions_uri=None, subscribe_exceptions_uri=None, uri=None):
        """
        MsgVpnAclProfileLinks - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'client_connect_exceptions_uri': 'str',
            'publish_exceptions_uri': 'str',
            'subscribe_exceptions_uri': 'str',
            'uri': 'str'
        }

        self.attribute_map = {
            'client_connect_exceptions_uri': 'clientConnectExceptionsUri',
            'publish_exceptions_uri': 'publishExceptionsUri',
            'subscribe_exceptions_uri': 'subscribeExceptionsUri',
            'uri': 'uri'
        }

        self._client_connect_exceptions_uri = client_connect_exceptions_uri
        self._publish_exceptions_uri = publish_exceptions_uri
        self._subscribe_exceptions_uri = subscribe_exceptions_uri
        self._uri = uri

    @property
    def client_connect_exceptions_uri(self):
        """
        Gets the client_connect_exceptions_uri of this MsgVpnAclProfileLinks.
        The URI of this MsgVpnAclProfile's clientConnectExceptions collection.

        :return: The client_connect_exceptions_uri of this MsgVpnAclProfileLinks.
        :rtype: str
        """
        return self._client_connect_exceptions_uri

    @client_connect_exceptions_uri.setter
    def client_connect_exceptions_uri(self, client_connect_exceptions_uri):
        """
        Sets the client_connect_exceptions_uri of this MsgVpnAclProfileLinks.
        The URI of this MsgVpnAclProfile's clientConnectExceptions collection.

        :param client_connect_exceptions_uri: The client_connect_exceptions_uri of this MsgVpnAclProfileLinks.
        :type: str
        """
    ...
    @property
    def publish_exceptions_uri(self):
        """
        Gets the publish_exceptions_uri of this MsgVpnAclProfileLinks.
        The URI of this MsgVpnAclProfile's publishExceptions collection.

        :return: The publish_exceptions_uri of this MsgVpnAclProfileLinks.
        :rtype: str
        """
        return self._publish_exceptions_uri

    @publish_exceptions_uri.setter
    def publish_exceptions_uri(self, publish_exceptions_uri):
        """
        Sets the publish_exceptions_uri of this MsgVpnAclProfileLinks.
        The URI of this MsgVpnAclProfile's publishExceptions collection.

        :param publish_exceptions_uri: The publish_exceptions_uri of this MsgVpnAclProfileLinks.
        :type: str
        """
    ...
    @property
    def subscribe_exceptions_uri(self):
        """
        Gets the subscribe_exceptions_uri of this MsgVpnAclProfileLinks.
        The URI of this MsgVpnAclProfile's subscribeExceptions collection.

        :return: The subscribe_exceptions_uri of this MsgVpnAclProfileLinks.
        :rtype: str
        """
        return self._subscribe_exceptions_uri

    @subscribe_exceptions_uri.setter
    def subscribe_exceptions_uri(self, subscribe_exceptions_uri):
        """
        Sets the subscribe_exceptions_uri of this MsgVpnAclProfileLinks.
        The URI of this MsgVpnAclProfile's subscribeExceptions collection.

        :param subscribe_exceptions_uri: The subscribe_exceptions_uri of this MsgVpnAclProfileLinks.
        :type: str
        """
    ...
    def uri(self):
        """
        Gets the uri of this MsgVpnAclProfileLinks.
        The URI of this MsgVpnAclProfile object.

        :return: The uri of this MsgVpnAclProfileLinks.
        :rtype: str
        """
        return self._uri
    ...
    def uri(self, uri):
        """
        Sets the uri of this MsgVpnAclProfileLinks.
        The URI of this MsgVpnAclProfile object.

        :param uri: The uri of this MsgVpnAclProfileLinks.
        :type: str
        """
