...
class MsgVpnAclProfileSubscribeExceptionsResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnAclProfileSubscribeExceptionsResponse - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'data': 'list[MsgVpnAclProfileSubscribeException]',
            'links': 'list[MsgVpnAclProfileSubscribeExceptionLinks]',
            'meta': 'SempMeta'
        }
    ...
    def data(self):
        """
        Gets the data of this MsgVpnAclProfileSubscribeExceptionsResponse.


        :return: The data of this MsgVpnAclProfileSubscribeExceptionsResponse.
        :rtype: list[MsgVpnAclProfileSubscribeException]
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnAclProfileSubscribeExceptionsResponse.


        :param data: The data of this MsgVpnAclProfileSubscribeExceptionsResponse.
        :type: list[MsgVpnAclProfileSubscribeException]
        """
    ...
    def links(self):
        """
        Gets the links of this MsgVpnAclProfileSubscribeExceptionsResponse.


        :return: The links of this MsgVpnAclProfileSubscribeExceptionsResponse.
        :rtype: list[MsgVpnAclProfileSubscribeExceptionLinks]
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnAclProfileSubscribeExceptionsResponse.


        :param links: The links of this MsgVpnAclProfileSubscribeExceptionsResponse.
        :type: list[MsgVpnAclProfileSubscribeExceptionLinks]
        """
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnAclProfileSubscribeExceptionsResponse.


        :return: The meta of this MsgVpnAclProfileSubscribeExceptionsResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnAclProfileSubscribeExceptionsResponse.


        :param meta: The meta of this MsgVpnAclProfileSubscribeExceptionsResponse.
        :type: SempMeta
        """
