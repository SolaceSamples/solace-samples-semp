...
class MsgVpnBridgeRemoteMsgVpnResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnBridgeRemoteMsgVpnResponse - a model defined in Swagger
    ...
    def data(self):
        """
        Gets the data of this MsgVpnBridgeRemoteMsgVpnResponse.


        :return: The data of this MsgVpnBridgeRemoteMsgVpnResponse.
        :rtype: MsgVpnBridgeRemoteMsgVpn
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnBridgeRemoteMsgVpnResponse.


        :param data: The data of this MsgVpnBridgeRemoteMsgVpnResponse.
    ...
    def links(self):
        """
        Gets the links of this MsgVpnBridgeRemoteMsgVpnResponse.


        :return: The links of this MsgVpnBridgeRemoteMsgVpnResponse.
        :rtype: MsgVpnBridgeRemoteMsgVpnLinks
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnBridgeRemoteMsgVpnResponse.


        :param links: The links of this MsgVpnBridgeRemoteMsgVpnResponse.
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnBridgeRemoteMsgVpnResponse.


        :return: The meta of this MsgVpnBridgeRemoteMsgVpnResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnBridgeRemoteMsgVpnResponse.


        :param meta: The meta of this MsgVpnBridgeRemoteMsgVpnResponse.
        :type: SempMeta
        """
