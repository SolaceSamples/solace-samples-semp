...
class MsgVpnQueueSubscriptionResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnQueueSubscriptionResponse - a model defined in Swagger
    ...
    def data(self):
        """
        Gets the data of this MsgVpnQueueSubscriptionResponse.


        :return: The data of this MsgVpnQueueSubscriptionResponse.
        :rtype: MsgVpnQueueSubscription
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnQueueSubscriptionResponse.


        :param data: The data of this MsgVpnQueueSubscriptionResponse.
    ...
    def links(self):
        """
        Gets the links of this MsgVpnQueueSubscriptionResponse.


        :return: The links of this MsgVpnQueueSubscriptionResponse.
        :rtype: MsgVpnQueueSubscriptionLinks
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnQueueSubscriptionResponse.


        :param links: The links of this MsgVpnQueueSubscriptionResponse.
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnQueueSubscriptionResponse.


        :return: The meta of this MsgVpnQueueSubscriptionResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnQueueSubscriptionResponse.


        :param meta: The meta of this MsgVpnQueueSubscriptionResponse.
        :type: SempMeta
        """
