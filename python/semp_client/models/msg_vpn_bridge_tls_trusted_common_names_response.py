...
class MsgVpnBridgeTlsTrustedCommonNamesResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnBridgeTlsTrustedCommonNamesResponse - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'data': 'list[MsgVpnBridgeTlsTrustedCommonName]',
            'links': 'list[MsgVpnBridgeTlsTrustedCommonNameLinks]',
            'meta': 'SempMeta'
        }
    ...
    def data(self):
        """
        Gets the data of this MsgVpnBridgeTlsTrustedCommonNamesResponse.


        :return: The data of this MsgVpnBridgeTlsTrustedCommonNamesResponse.
        :rtype: list[MsgVpnBridgeTlsTrustedCommonName]
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnBridgeTlsTrustedCommonNamesResponse.


        :param data: The data of this MsgVpnBridgeTlsTrustedCommonNamesResponse.
        :type: list[MsgVpnBridgeTlsTrustedCommonName]
        """
    ...
    def links(self):
        """
        Gets the links of this MsgVpnBridgeTlsTrustedCommonNamesResponse.


        :return: The links of this MsgVpnBridgeTlsTrustedCommonNamesResponse.
        :rtype: list[MsgVpnBridgeTlsTrustedCommonNameLinks]
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnBridgeTlsTrustedCommonNamesResponse.


        :param links: The links of this MsgVpnBridgeTlsTrustedCommonNamesResponse.
        :type: list[MsgVpnBridgeTlsTrustedCommonNameLinks]
        """
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnBridgeTlsTrustedCommonNamesResponse.


        :return: The meta of this MsgVpnBridgeTlsTrustedCommonNamesResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnBridgeTlsTrustedCommonNamesResponse.


        :param meta: The meta of this MsgVpnBridgeTlsTrustedCommonNamesResponse.
        :type: SempMeta
        """
