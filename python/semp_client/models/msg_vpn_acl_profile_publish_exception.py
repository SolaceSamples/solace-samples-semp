...
class MsgVpnAclProfilePublishException(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, acl_profile_name=None, msg_vpn_name=None, publish_exception_topic=None, topic_syntax=None):
        """
        MsgVpnAclProfilePublishException - a model defined in Swagger
        ...
        self.attribute_map = {
            ...
            'publish_exception_topic': 'publishExceptionTopic',
            'topic_syntax': 'topicSyntax'
        }

        self._acl_profile_name = acl_profile_name
        self._msg_vpn_name = msg_vpn_name
        self._publish_exception_topic = publish_exception_topic
        self._topic_syntax = topic_syntax

    @property
    def acl_profile_name(self):
        """
        Gets the acl_profile_name of this MsgVpnAclProfilePublishException.
        The name of the ACL Profile.

        :return: The acl_profile_name of this MsgVpnAclProfilePublishException.
        :rtype: str
        """
    ...
    def acl_profile_name(self, acl_profile_name):
        """
        Sets the acl_profile_name of this MsgVpnAclProfilePublishException.
        The name of the ACL Profile.

        :param acl_profile_name: The acl_profile_name of this MsgVpnAclProfilePublishException.
        :type: str
        """
    ...
    def msg_vpn_name(self):
        """
        Gets the msg_vpn_name of this MsgVpnAclProfilePublishException.
        The name of the Message VPN.

        :return: The msg_vpn_name of this MsgVpnAclProfilePublishException.
        :rtype: str
        """
    ...
    def msg_vpn_name(self, msg_vpn_name):
        """
        Sets the msg_vpn_name of this MsgVpnAclProfilePublishException.
        The name of the Message VPN.

        :param msg_vpn_name: The msg_vpn_name of this MsgVpnAclProfilePublishException.
        :type: str
        """
    ...
    @property
    def publish_exception_topic(self):
        """
        Gets the publish_exception_topic of this MsgVpnAclProfilePublishException.
        The topic of the Exception. May include syntax-appropriate wildcards.

        :return: The publish_exception_topic of this MsgVpnAclProfilePublishException.
        :rtype: str
        """
        return self._publish_exception_topic

    @publish_exception_topic.setter
    def publish_exception_topic(self, publish_exception_topic):
        """
        Sets the publish_exception_topic of this MsgVpnAclProfilePublishException.
        The topic of the Exception. May include syntax-appropriate wildcards.

        :param publish_exception_topic: The publish_exception_topic of this MsgVpnAclProfilePublishException.
        :type: str
        """
    ...
    def topic_syntax(self):
        """
        Gets the topic_syntax of this MsgVpnAclProfilePublishException.
        ...
        :return: The topic_syntax of this MsgVpnAclProfilePublishException.
        :rtype: str
        """
    ...
    def topic_syntax(self, topic_syntax):
        """
        Sets the topic_syntax of this MsgVpnAclProfilePublishException.
        The syntax of the topic of the Exception. The allowed values and their meaning are:      \"smf\" - Topic uses SMF syntax.     \"mqtt\" - Topic uses MQTT syntax. 

        :param topic_syntax: The topic_syntax of this MsgVpnAclProfilePublishException.
        :type: str
        """
