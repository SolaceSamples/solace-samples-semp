...
class MsgVpnMqttSessionSubscription(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, mqtt_session_client_id=None, mqtt_session_virtual_router=None, msg_vpn_name=None, subscription_qos=None, subscription_topic=None):
        """
        MsgVpnMqttSessionSubscription - a model defined in Swagger
        ...
        self.attribute_map = {
            ...
            'subscription_qos': 'subscriptionQos',
        ...
        self._subscription_qos = subscription_qos
        self._subscription_topic = subscription_topic

    @property
    def mqtt_session_client_id(self):
        """
        Gets the mqtt_session_client_id of this MsgVpnMqttSessionSubscription.
        The client-id of the MQTT Session, which corresponds to the ClientId provided in the MQTT CONNECT packet.

        :return: The mqtt_session_client_id of this MsgVpnMqttSessionSubscription.
        :rtype: str
        """
    ...
    def mqtt_session_client_id(self, mqtt_session_client_id):
        """
        Sets the mqtt_session_client_id of this MsgVpnMqttSessionSubscription.
        The client-id of the MQTT Session, which corresponds to the ClientId provided in the MQTT CONNECT packet.

        :param mqtt_session_client_id: The mqtt_session_client_id of this MsgVpnMqttSessionSubscription.
        :type: str
        """
    ...
    def mqtt_session_virtual_router(self):
        """
        Gets the mqtt_session_virtual_router of this MsgVpnMqttSessionSubscription.
        The virtual-router of the MQTT Session. The allowed values and their meaning are:      \"primary\" - MQTT Session belongs to the primary virtual-router.     \"backup\" - MQTT Session belongs to the backup virtual-router. 

        :return: The mqtt_session_virtual_router of this MsgVpnMqttSessionSubscription.
        :rtype: str
        """
    ...
    def mqtt_session_virtual_router(self, mqtt_session_virtual_router):
        """
        Sets the mqtt_session_virtual_router of this MsgVpnMqttSessionSubscription.
        The virtual-router of the MQTT Session. The allowed values and their meaning are:      \"primary\" - MQTT Session belongs to the primary virtual-router.     \"backup\" - MQTT Session belongs to the backup virtual-router. 

        :param mqtt_session_virtual_router: The mqtt_session_virtual_router of this MsgVpnMqttSessionSubscription.
        :type: str
        """
        allowed_values = ["primary", "backup"]
        if mqtt_session_virtual_router not in allowed_values:
            raise ValueError(
                "Invalid value for `mqtt_session_virtual_router` ({0}), must be one of {1}"
    ...
    def msg_vpn_name(self):
        """
        Gets the msg_vpn_name of this MsgVpnMqttSessionSubscription.
        The name of the Message VPN.

        :return: The msg_vpn_name of this MsgVpnMqttSessionSubscription.
        :rtype: str
        """
    ...
    def msg_vpn_name(self, msg_vpn_name):
        """
        Sets the msg_vpn_name of this MsgVpnMqttSessionSubscription.
        The name of the Message VPN.

        :param msg_vpn_name: The msg_vpn_name of this MsgVpnMqttSessionSubscription.
        :type: str
        """
    ...
    @property
    def subscription_qos(self):
        """
        Gets the subscription_qos of this MsgVpnMqttSessionSubscription.
        ...
        :return: The subscription_qos of this MsgVpnMqttSessionSubscription.
        :rtype: int
        """
        return self._subscription_qos

    @subscription_qos.setter
    def subscription_qos(self, subscription_qos):
        """
        Sets the subscription_qos of this MsgVpnMqttSessionSubscription.
        The quality of service for the subscription. The value is either `0` (deliver at most once) or `1` (deliver at least once). The default value is `0`.

        :param subscription_qos: The subscription_qos of this MsgVpnMqttSessionSubscription.
        :type: int
        """
    ...
    def subscription_topic(self):
        """
        Gets the subscription_topic of this MsgVpnMqttSessionSubscription.
        An MQTT topic string.

        :return: The subscription_topic of this MsgVpnMqttSessionSubscription.
        :rtype: str
        """
        return self._subscription_topic

    @subscription_topic.setter
    def subscription_topic(self, subscription_topic):
        """
        Sets the subscription_topic of this MsgVpnMqttSessionSubscription.
        An MQTT topic string.

        :param subscription_topic: The subscription_topic of this MsgVpnMqttSessionSubscription.
        :type: str
        """
