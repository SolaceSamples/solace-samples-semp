...
class MsgVpnRestDeliveryPointsResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnRestDeliveryPointsResponse - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'data': 'list[MsgVpnRestDeliveryPoint]',
            'links': 'list[MsgVpnRestDeliveryPointLinks]',
            'meta': 'SempMeta'
        }
    ...
    def data(self):
        """
        Gets the data of this MsgVpnRestDeliveryPointsResponse.


        :return: The data of this MsgVpnRestDeliveryPointsResponse.
        :rtype: list[MsgVpnRestDeliveryPoint]
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnRestDeliveryPointsResponse.


        :param data: The data of this MsgVpnRestDeliveryPointsResponse.
        :type: list[MsgVpnRestDeliveryPoint]
        """
    ...
    def links(self):
        """
        Gets the links of this MsgVpnRestDeliveryPointsResponse.


        :return: The links of this MsgVpnRestDeliveryPointsResponse.
        :rtype: list[MsgVpnRestDeliveryPointLinks]
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnRestDeliveryPointsResponse.


        :param links: The links of this MsgVpnRestDeliveryPointsResponse.
        :type: list[MsgVpnRestDeliveryPointLinks]
        """
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnRestDeliveryPointsResponse.


        :return: The meta of this MsgVpnRestDeliveryPointsResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnRestDeliveryPointsResponse.


        :param meta: The meta of this MsgVpnRestDeliveryPointsResponse.
        :type: SempMeta
        """
