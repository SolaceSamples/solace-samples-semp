...
class MsgVpnBridgesResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnBridgesResponse - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'data': 'list[MsgVpnBridge]',
            'links': 'list[MsgVpnBridgeLinks]',
            'meta': 'SempMeta'
        }
    ...
    def data(self):
        """
        Gets the data of this MsgVpnBridgesResponse.


        :return: The data of this MsgVpnBridgesResponse.
        :rtype: list[MsgVpnBridge]
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnBridgesResponse.


        :param data: The data of this MsgVpnBridgesResponse.
        :type: list[MsgVpnBridge]
        """
    ...
    def links(self):
        """
        Gets the links of this MsgVpnBridgesResponse.


        :return: The links of this MsgVpnBridgesResponse.
        :rtype: list[MsgVpnBridgeLinks]
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnBridgesResponse.


        :param links: The links of this MsgVpnBridgesResponse.
        :type: list[MsgVpnBridgeLinks]
        """
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnBridgesResponse.


        :return: The meta of this MsgVpnBridgesResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnBridgesResponse.


        :param meta: The meta of this MsgVpnBridgesResponse.
        :type: SempMeta
        """
