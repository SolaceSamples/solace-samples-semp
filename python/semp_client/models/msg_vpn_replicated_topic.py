...
class MsgVpnReplicatedTopic(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, msg_vpn_name=None, replicated_topic=None, replication_mode=None):
        """
        MsgVpnReplicatedTopic - a model defined in Swagger
        ...
        self.swagger_types = {
            'msg_vpn_name': 'str',
            'replicated_topic': 'str',
            'replication_mode': 'str'
        }

        self.attribute_map = {
            'msg_vpn_name': 'msgVpnName',
            'replicated_topic': 'replicatedTopic',
            'replication_mode': 'replicationMode'
        }

        self._msg_vpn_name = msg_vpn_name
        self._replicated_topic = replicated_topic
        self._replication_mode = replication_mode

    @property
    def msg_vpn_name(self):
        """
        Gets the msg_vpn_name of this MsgVpnReplicatedTopic.
        The name of the Message VPN.

        :return: The msg_vpn_name of this MsgVpnReplicatedTopic.
        :rtype: str
        """
    ...
    def msg_vpn_name(self, msg_vpn_name):
        """
        Sets the msg_vpn_name of this MsgVpnReplicatedTopic.
        The name of the Message VPN.

        :param msg_vpn_name: The msg_vpn_name of this MsgVpnReplicatedTopic.
        :type: str
        """
    ...
    @property
    def replicated_topic(self):
        """
        Gets the replicated_topic of this MsgVpnReplicatedTopic.
        Topic for applying replication. Published messages matching this topic will be replicated to the standby site.

        :return: The replicated_topic of this MsgVpnReplicatedTopic.
        :rtype: str
        """
        return self._replicated_topic

    @replicated_topic.setter
    def replicated_topic(self, replicated_topic):
        """
        Sets the replicated_topic of this MsgVpnReplicatedTopic.
        Topic for applying replication. Published messages matching this topic will be replicated to the standby site.

        :param replicated_topic: The replicated_topic of this MsgVpnReplicatedTopic.
        :type: str
        """
    ...
    def replication_mode(self):
        """
        Gets the replication_mode of this MsgVpnReplicatedTopic.
        ...
        :return: The replication_mode of this MsgVpnReplicatedTopic.
        :rtype: str
        """
    ...
    def replication_mode(self, replication_mode):
        """
        Sets the replication_mode of this MsgVpnReplicatedTopic.
        Choose the replication-mode for the Replicated Topic. The default value is `\"async\"`. The allowed values and their meaning are:      \"sync\" - Synchronous replication-mode. Published messages are acknowledged when they are spooled on the standby site.     \"async\" - Asynchronous replication-mode. Published messages are acknowledged when they are spooled locally. 

        :param replication_mode: The replication_mode of this MsgVpnReplicatedTopic.
        :type: str
        """
        allowed_values = ["sync", "async"]
        if replication_mode not in allowed_values:
            raise ValueError(
                "Invalid value for `replication_mode` ({0}), must be one of {1}"
