...
class MsgVpnBridgeRemoteSubscriptionsResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnBridgeRemoteSubscriptionsResponse - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'data': 'list[MsgVpnBridgeRemoteSubscription]',
            'links': 'list[MsgVpnBridgeRemoteSubscriptionLinks]',
            'meta': 'SempMeta'
        }
    ...
    def data(self):
        """
        Gets the data of this MsgVpnBridgeRemoteSubscriptionsResponse.


        :return: The data of this MsgVpnBridgeRemoteSubscriptionsResponse.
        :rtype: list[MsgVpnBridgeRemoteSubscription]
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnBridgeRemoteSubscriptionsResponse.


        :param data: The data of this MsgVpnBridgeRemoteSubscriptionsResponse.
        :type: list[MsgVpnBridgeRemoteSubscription]
        """
    ...
    def links(self):
        """
        Gets the links of this MsgVpnBridgeRemoteSubscriptionsResponse.


        :return: The links of this MsgVpnBridgeRemoteSubscriptionsResponse.
        :rtype: list[MsgVpnBridgeRemoteSubscriptionLinks]
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnBridgeRemoteSubscriptionsResponse.


        :param links: The links of this MsgVpnBridgeRemoteSubscriptionsResponse.
        :type: list[MsgVpnBridgeRemoteSubscriptionLinks]
        """
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnBridgeRemoteSubscriptionsResponse.


        :return: The meta of this MsgVpnBridgeRemoteSubscriptionsResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnBridgeRemoteSubscriptionsResponse.


        :param meta: The meta of this MsgVpnBridgeRemoteSubscriptionsResponse.
        :type: SempMeta
        """
