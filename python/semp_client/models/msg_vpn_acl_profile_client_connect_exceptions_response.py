...
class MsgVpnAclProfileClientConnectExceptionsResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnAclProfileClientConnectExceptionsResponse - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'data': 'list[MsgVpnAclProfileClientConnectException]',
            'links': 'list[MsgVpnAclProfileClientConnectExceptionLinks]',
            'meta': 'SempMeta'
        }
    ...
    def data(self):
        """
        Gets the data of this MsgVpnAclProfileClientConnectExceptionsResponse.


        :return: The data of this MsgVpnAclProfileClientConnectExceptionsResponse.
        :rtype: list[MsgVpnAclProfileClientConnectException]
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnAclProfileClientConnectExceptionsResponse.


        :param data: The data of this MsgVpnAclProfileClientConnectExceptionsResponse.
        :type: list[MsgVpnAclProfileClientConnectException]
        """
    ...
    def links(self):
        """
        Gets the links of this MsgVpnAclProfileClientConnectExceptionsResponse.


        :return: The links of this MsgVpnAclProfileClientConnectExceptionsResponse.
        :rtype: list[MsgVpnAclProfileClientConnectExceptionLinks]
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnAclProfileClientConnectExceptionsResponse.


        :param links: The links of this MsgVpnAclProfileClientConnectExceptionsResponse.
        :type: list[MsgVpnAclProfileClientConnectExceptionLinks]
        """
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnAclProfileClientConnectExceptionsResponse.


        :return: The meta of this MsgVpnAclProfileClientConnectExceptionsResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnAclProfileClientConnectExceptionsResponse.


        :param meta: The meta of this MsgVpnAclProfileClientConnectExceptionsResponse.
        :type: SempMeta
        """
