...
class MsgVpnAclProfilePublishExceptionResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnAclProfilePublishExceptionResponse - a model defined in Swagger
    ...
    def data(self):
        """
        Gets the data of this MsgVpnAclProfilePublishExceptionResponse.


        :return: The data of this MsgVpnAclProfilePublishExceptionResponse.
        :rtype: MsgVpnAclProfilePublishException
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnAclProfilePublishExceptionResponse.


        :param data: The data of this MsgVpnAclProfilePublishExceptionResponse.
    ...
    def links(self):
        """
        Gets the links of this MsgVpnAclProfilePublishExceptionResponse.


        :return: The links of this MsgVpnAclProfilePublishExceptionResponse.
        :rtype: MsgVpnAclProfilePublishExceptionLinks
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnAclProfilePublishExceptionResponse.


        :param links: The links of this MsgVpnAclProfilePublishExceptionResponse.
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnAclProfilePublishExceptionResponse.


        :return: The meta of this MsgVpnAclProfilePublishExceptionResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnAclProfilePublishExceptionResponse.


        :param meta: The meta of this MsgVpnAclProfilePublishExceptionResponse.
        :type: SempMeta
        """
