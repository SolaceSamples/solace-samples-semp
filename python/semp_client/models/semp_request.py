...
class SempRequest(object):
    ...
    def __init__(self, method=None, uri=None):
        """
        SempRequest - a model defined in Swagger
    ...
    def method(self):
        """
        Gets the method of this SempRequest.
        The HTTP method of the request which resulted in this response.

        :return: The method of this SempRequest.
        :rtype: str
        """
        return self._method
    ...
    def method(self, method):
        """
        Sets the method of this SempRequest.
        The HTTP method of the request which resulted in this response.

        :param method: The method of this SempRequest.
        :type: str
        """
    ...
    def uri(self):
        """
        Gets the uri of this SempRequest.
        The URI of the request which resulted in this response.

        :return: The uri of this SempRequest.
        :rtype: str
        """
        return self._uri
    ...
    def uri(self, uri):
        """
        Sets the uri of this SempRequest.
        The URI of the request which resulted in this response.

        :param uri: The uri of this SempRequest.
        :type: str
        """
