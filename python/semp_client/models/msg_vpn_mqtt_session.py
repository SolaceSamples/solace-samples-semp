...
class MsgVpnMqttSession(object):
    ...
    """
    def __init__(self, enabled=None, mqtt_session_client_id=None, mqtt_session_virtual_router=None, msg_vpn_name=None, owner=None):
        """
        MsgVpnMqttSession - a model defined in Swagger
    ...
    def enabled(self):
        """
        Gets the enabled of this MsgVpnMqttSession.
        ...
        :return: The enabled of this MsgVpnMqttSession.
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        ...
        :param enabled: The enabled of this MsgVpnMqttSession.
        :type: bool
        """
    ...
    def mqtt_session_client_id(self):
        """
        Gets the mqtt_session_client_id of this MsgVpnMqttSession.
        The client-id of the MQTT Session, which corresponds to the ClientId provided in the MQTT CONNECT packet.

        :return: The mqtt_session_client_id of this MsgVpnMqttSession.
        :rtype: str
        """
    ...
    def mqtt_session_client_id(self, mqtt_session_client_id):
        ...
        :param mqtt_session_client_id: The mqtt_session_client_id of this MsgVpnMqttSession.
        :type: str
        """
    ...
    def mqtt_session_virtual_router(self):
        """
        Gets the mqtt_session_virtual_router of this MsgVpnMqttSession.
        ...
        :return: The mqtt_session_virtual_router of this MsgVpnMqttSession.
        :rtype: str
        """
    ...
    def mqtt_session_virtual_router(self, mqtt_session_virtual_router):
        ...
        :param mqtt_session_virtual_router: The mqtt_session_virtual_router of this MsgVpnMqttSession.
        :type: str
        """
    ...
    def msg_vpn_name(self):
        """
        Gets the msg_vpn_name of this MsgVpnMqttSession.
        The name of the Message VPN.

        :return: The msg_vpn_name of this MsgVpnMqttSession.
        :rtype: str
        """
    ...
    def msg_vpn_name(self, msg_vpn_name):
        ...
        :param msg_vpn_name: The msg_vpn_name of this MsgVpnMqttSession.
        :type: str
        """
    ...
    def owner(self):
        """
        Gets the owner of this MsgVpnMqttSession.
        The owner of the MQTT Session. For externally-created sessions this will be the Client Username of the connecting client. For management-created sessions this will be empty by default. In either case the owner can be changed by the administrator. The MQTT Session must be disabled to change its owner. The default is to have no `owner`.

        :return: The owner of this MsgVpnMqttSession.
        :rtype: str
        """
        return self._owner
    ...
    def owner(self, owner):
        ...
        :param owner: The owner of this MsgVpnMqttSession.
        :type: str
        """
