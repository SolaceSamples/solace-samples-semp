...
class MsgVpnAclProfileClientConnectException(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, acl_profile_name=None, client_connect_exception_address=None, msg_vpn_name=None):
        """
        MsgVpnAclProfileClientConnectException - a model defined in Swagger
        ...
        self.swagger_types = {
            ...
            'client_connect_exception_address': 'str',
            'msg_vpn_name': 'str'
        }

        self.attribute_map = {
            'acl_profile_name': 'aclProfileName',
            'client_connect_exception_address': 'clientConnectExceptionAddress',
            'msg_vpn_name': 'msgVpnName'
        }

        self._acl_profile_name = acl_profile_name
        self._client_connect_exception_address = client_connect_exception_address
        self._msg_vpn_name = msg_vpn_name

    @property
    def acl_profile_name(self):
        """
        Gets the acl_profile_name of this MsgVpnAclProfileClientConnectException.
        The name of the ACL Profile.

        :return: The acl_profile_name of this MsgVpnAclProfileClientConnectException.
        :rtype: str
        """
    ...
    def acl_profile_name(self, acl_profile_name):
        """
        Sets the acl_profile_name of this MsgVpnAclProfileClientConnectException.
        The name of the ACL Profile.

        :param acl_profile_name: The acl_profile_name of this MsgVpnAclProfileClientConnectException.
        :type: str
        """
    ...
    @property
    def client_connect_exception_address(self):
        """
        Gets the client_connect_exception_address of this MsgVpnAclProfileClientConnectException.
        The IP address/Netmask in CIDR form of the Client Connect Exception.

        :return: The client_connect_exception_address of this MsgVpnAclProfileClientConnectException.
        :rtype: str
        """
        return self._client_connect_exception_address

    @client_connect_exception_address.setter
    def client_connect_exception_address(self, client_connect_exception_address):
        """
        Sets the client_connect_exception_address of this MsgVpnAclProfileClientConnectException.
        The IP address/Netmask in CIDR form of the Client Connect Exception.

        :param client_connect_exception_address: The client_connect_exception_address of this MsgVpnAclProfileClientConnectException.
        :type: str
        """
    ...
    def msg_vpn_name(self):
        """
        Gets the msg_vpn_name of this MsgVpnAclProfileClientConnectException.
        The name of the Message VPN.

        :return: The msg_vpn_name of this MsgVpnAclProfileClientConnectException.
        :rtype: str
        """
    ...
    def msg_vpn_name(self, msg_vpn_name):
        """
        Sets the msg_vpn_name of this MsgVpnAclProfileClientConnectException.
        The name of the Message VPN.

        :param msg_vpn_name: The msg_vpn_name of this MsgVpnAclProfileClientConnectException.
        :type: str
        """
