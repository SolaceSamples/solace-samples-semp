...
class MsgVpnRestDeliveryPointQueueBindingResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnRestDeliveryPointQueueBindingResponse - a model defined in Swagger
    ...
    def data(self):
        """
        Gets the data of this MsgVpnRestDeliveryPointQueueBindingResponse.


        :return: The data of this MsgVpnRestDeliveryPointQueueBindingResponse.
        :rtype: MsgVpnRestDeliveryPointQueueBinding
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnRestDeliveryPointQueueBindingResponse.


        :param data: The data of this MsgVpnRestDeliveryPointQueueBindingResponse.
    ...
    def links(self):
        """
        Gets the links of this MsgVpnRestDeliveryPointQueueBindingResponse.


        :return: The links of this MsgVpnRestDeliveryPointQueueBindingResponse.
        :rtype: MsgVpnRestDeliveryPointQueueBindingLinks
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnRestDeliveryPointQueueBindingResponse.


        :param links: The links of this MsgVpnRestDeliveryPointQueueBindingResponse.
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnRestDeliveryPointQueueBindingResponse.


        :return: The meta of this MsgVpnRestDeliveryPointQueueBindingResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnRestDeliveryPointQueueBindingResponse.


        :param meta: The meta of this MsgVpnRestDeliveryPointQueueBindingResponse.
        :type: SempMeta
        """
