...
class MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'data': 'list[MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName]',
            'links': 'list[MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks]',
            'meta': 'SempMeta'
        }
    ...
    def data(self):
        """
        Gets the data of this MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse.


        :return: The data of this MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse.
        :rtype: list[MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName]
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse.


        :param data: The data of this MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse.
        :type: list[MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName]
        """
    ...
    def links(self):
        """
        Gets the links of this MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse.


        :return: The links of this MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse.
        :rtype: list[MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks]
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse.


        :param links: The links of this MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse.
        :type: list[MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks]
        """
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse.


        :return: The meta of this MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse.


        :param meta: The meta of this MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse.
        :type: SempMeta
        """
