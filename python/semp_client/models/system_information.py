...
class SystemInformation(object):
    ...
    """
    def __init__(self, platform=None, semp_version=None):
        """
        ...
        self.attribute_map = {
            'platform': 'platform',
            'semp_version': 'sempVersion'
        }

        self._platform = platform
        self._semp_version = semp_version

    @property
    def platform(self):
        """
        Gets the platform of this SystemInformation.
        The platform that is running the API.

        :return: The platform of this SystemInformation.
        :rtype: str
        """
    ...
    def platform(self, platform):
        """
        Sets the platform of this SystemInformation.
        The platform that is running the API.

        :param platform: The platform of this SystemInformation.
        :type: str
        """
    ...
    @property
    def semp_version(self):
        """
        Gets the semp_version of this SystemInformation.
        The SEMP API version.

        :return: The semp_version of this SystemInformation.
        :rtype: str
        """
        return self._semp_version

    @semp_version.setter
    def semp_version(self, semp_version):
        """
        Sets the semp_version of this SystemInformation.
        The SEMP API version.

        :param semp_version: The semp_version of this SystemInformation.
        :type: str
        """
