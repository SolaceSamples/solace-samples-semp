...
class MsgVpnRestDeliveryPointLinks(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, queue_bindings_uri=None, rest_consumers_uri=None, uri=None):
        """
        MsgVpnRestDeliveryPointLinks - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'queue_bindings_uri': 'str',
            'rest_consumers_uri': 'str',
            'uri': 'str'
        }

        self.attribute_map = {
            'queue_bindings_uri': 'queueBindingsUri',
            'rest_consumers_uri': 'restConsumersUri',
            'uri': 'uri'
        }

        self._queue_bindings_uri = queue_bindings_uri
        self._rest_consumers_uri = rest_consumers_uri
        self._uri = uri

    @property
    def queue_bindings_uri(self):
        """
        Gets the queue_bindings_uri of this MsgVpnRestDeliveryPointLinks.
        The URI of this MsgVpnRestDeliveryPoint's queueBindings collection.

        :return: The queue_bindings_uri of this MsgVpnRestDeliveryPointLinks.
        :rtype: str
        """
        return self._queue_bindings_uri

    @queue_bindings_uri.setter
    def queue_bindings_uri(self, queue_bindings_uri):
        """
        Sets the queue_bindings_uri of this MsgVpnRestDeliveryPointLinks.
        The URI of this MsgVpnRestDeliveryPoint's queueBindings collection.

        :param queue_bindings_uri: The queue_bindings_uri of this MsgVpnRestDeliveryPointLinks.
        :type: str
        """
    ...
    @property
    def rest_consumers_uri(self):
        """
        Gets the rest_consumers_uri of this MsgVpnRestDeliveryPointLinks.
        The URI of this MsgVpnRestDeliveryPoint's restConsumers collection.

        :return: The rest_consumers_uri of this MsgVpnRestDeliveryPointLinks.
        :rtype: str
        """
        return self._rest_consumers_uri

    @rest_consumers_uri.setter
    def rest_consumers_uri(self, rest_consumers_uri):
        """
        Sets the rest_consumers_uri of this MsgVpnRestDeliveryPointLinks.
        The URI of this MsgVpnRestDeliveryPoint's restConsumers collection.

        :param rest_consumers_uri: The rest_consumers_uri of this MsgVpnRestDeliveryPointLinks.
        :type: str
        """
    ...
    def uri(self):
        """
        Gets the uri of this MsgVpnRestDeliveryPointLinks.
        The URI of this MsgVpnRestDeliveryPoint object.

        :return: The uri of this MsgVpnRestDeliveryPointLinks.
        :rtype: str
        """
        return self._uri
    ...
    def uri(self, uri):
        """
        Sets the uri of this MsgVpnRestDeliveryPointLinks.
        The URI of this MsgVpnRestDeliveryPoint object.

        :param uri: The uri of this MsgVpnRestDeliveryPointLinks.
        :type: str
        """
