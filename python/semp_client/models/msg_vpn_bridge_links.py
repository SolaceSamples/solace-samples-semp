...
class MsgVpnBridgeLinks(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, remote_msg_vpns_uri=None, remote_subscriptions_uri=None, tls_trusted_common_names_uri=None, uri=None):
        """
        MsgVpnBridgeLinks - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'remote_msg_vpns_uri': 'str',
            'remote_subscriptions_uri': 'str',
            'tls_trusted_common_names_uri': 'str',
            'uri': 'str'
        }

        self.attribute_map = {
            'remote_msg_vpns_uri': 'remoteMsgVpnsUri',
            'remote_subscriptions_uri': 'remoteSubscriptionsUri',
            'tls_trusted_common_names_uri': 'tlsTrustedCommonNamesUri',
            'uri': 'uri'
        }

        self._remote_msg_vpns_uri = remote_msg_vpns_uri
        self._remote_subscriptions_uri = remote_subscriptions_uri
        self._tls_trusted_common_names_uri = tls_trusted_common_names_uri
        self._uri = uri

    @property
    def remote_msg_vpns_uri(self):
        """
        Gets the remote_msg_vpns_uri of this MsgVpnBridgeLinks.
        The URI of this MsgVpnBridge's remoteMsgVpns collection.

        :return: The remote_msg_vpns_uri of this MsgVpnBridgeLinks.
        :rtype: str
        """
        return self._remote_msg_vpns_uri

    @remote_msg_vpns_uri.setter
    def remote_msg_vpns_uri(self, remote_msg_vpns_uri):
        """
        Sets the remote_msg_vpns_uri of this MsgVpnBridgeLinks.
        The URI of this MsgVpnBridge's remoteMsgVpns collection.

        :param remote_msg_vpns_uri: The remote_msg_vpns_uri of this MsgVpnBridgeLinks.
        :type: str
        """
    ...
    @property
    def remote_subscriptions_uri(self):
        """
        Gets the remote_subscriptions_uri of this MsgVpnBridgeLinks.
        The URI of this MsgVpnBridge's remoteSubscriptions collection.

        :return: The remote_subscriptions_uri of this MsgVpnBridgeLinks.
        :rtype: str
        """
        return self._remote_subscriptions_uri

    @remote_subscriptions_uri.setter
    def remote_subscriptions_uri(self, remote_subscriptions_uri):
        """
        Sets the remote_subscriptions_uri of this MsgVpnBridgeLinks.
        The URI of this MsgVpnBridge's remoteSubscriptions collection.

        :param remote_subscriptions_uri: The remote_subscriptions_uri of this MsgVpnBridgeLinks.
        :type: str
        """
    ...
    @property
    def tls_trusted_common_names_uri(self):
        """
        Gets the tls_trusted_common_names_uri of this MsgVpnBridgeLinks.
        The URI of this MsgVpnBridge's tlsTrustedCommonNames collection.

        :return: The tls_trusted_common_names_uri of this MsgVpnBridgeLinks.
        :rtype: str
        """
        return self._tls_trusted_common_names_uri

    @tls_trusted_common_names_uri.setter
    def tls_trusted_common_names_uri(self, tls_trusted_common_names_uri):
        """
        Sets the tls_trusted_common_names_uri of this MsgVpnBridgeLinks.
        The URI of this MsgVpnBridge's tlsTrustedCommonNames collection.

        :param tls_trusted_common_names_uri: The tls_trusted_common_names_uri of this MsgVpnBridgeLinks.
        :type: str
        """
    ...
    def uri(self):
        """
        Gets the uri of this MsgVpnBridgeLinks.
        The URI of this MsgVpnBridge object.

        :return: The uri of this MsgVpnBridgeLinks.
        :rtype: str
        """
        return self._uri
    ...
    def uri(self, uri):
        """
        Sets the uri of this MsgVpnBridgeLinks.
        The URI of this MsgVpnBridge object.

        :param uri: The uri of this MsgVpnBridgeLinks.
        :type: str
        """
