...
class MsgVpnClientUsernamesResponse(object):
    """
    ...
    def __init__(self, data=None, links=None, meta=None):
        """
        MsgVpnClientUsernamesResponse - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'data': 'list[MsgVpnClientUsername]',
            'links': 'list[MsgVpnClientUsernameLinks]',
            'meta': 'SempMeta'
        }
    ...
    def data(self):
        """
        Gets the data of this MsgVpnClientUsernamesResponse.


        :return: The data of this MsgVpnClientUsernamesResponse.
        :rtype: list[MsgVpnClientUsername]
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this MsgVpnClientUsernamesResponse.


        :param data: The data of this MsgVpnClientUsernamesResponse.
        :type: list[MsgVpnClientUsername]
        """
    ...
    def links(self):
        """
        Gets the links of this MsgVpnClientUsernamesResponse.


        :return: The links of this MsgVpnClientUsernamesResponse.
        :rtype: list[MsgVpnClientUsernameLinks]
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this MsgVpnClientUsernamesResponse.


        :param links: The links of this MsgVpnClientUsernamesResponse.
        :type: list[MsgVpnClientUsernameLinks]
        """
    ...
    def meta(self):
        """
        Gets the meta of this MsgVpnClientUsernamesResponse.


        :return: The meta of this MsgVpnClientUsernamesResponse.
        :rtype: SempMeta
        """
        return self._meta
    ...
    def meta(self, meta):
        """
        Sets the meta of this MsgVpnClientUsernamesResponse.


        :param meta: The meta of this MsgVpnClientUsernamesResponse.
        :type: SempMeta
        """
