...
class SempMeta(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, error=None, paging=None, request=None, response_code=None):
        """
        SempMeta - a model defined in Swagger
    ...
    def error(self):
        """
        Gets the error of this SempMeta.


        :return: The error of this SempMeta.
        :rtype: SempError
        """
        return self._error
    ...
    def error(self, error):
        """
        Sets the error of this SempMeta.


        :param error: The error of this SempMeta.
        :type: SempError
        """
    ...
    def paging(self):
        """
        Gets the paging of this SempMeta.


        :return: The paging of this SempMeta.
        :rtype: SempPaging
        """
        return self._paging
    ...
    def paging(self, paging):
        """
        Sets the paging of this SempMeta.


        :param paging: The paging of this SempMeta.
        :type: SempPaging
        """
    ...
    def request(self):
        """
        Gets the request of this SempMeta.


        :return: The request of this SempMeta.
        :rtype: SempRequest
        """
    ...
    def request(self, request):
        """
        Sets the request of this SempMeta.


        :param request: The request of this SempMeta.
        :type: SempRequest
        """
    ...
    def response_code(self):
        """
        Gets the response_code of this SempMeta.
        The HTTP response code, one of 200 (success), 4xx (client error), or 5xx (server error).

        :return: The response_code of this SempMeta.
        :rtype: int
        """
    ...
    def response_code(self, response_code):
        """
        Sets the response_code of this SempMeta.
        The HTTP response code, one of 200 (success), 4xx (client error), or 5xx (server error).

        :param response_code: The response_code of this SempMeta.
        :type: int
        """
