...
describe SempClient::Configuration do
  let(:config) { SempClient::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    #require 'URI'
    #uri = URI.parse("http://www.solacesystems.com/SEMP/v2/config")
    #SempClient.configure do |c|
    #  c.host = uri.host
  ...
  describe '#base_url' do
    it 'should have the default value' do
      ...
      #expect(config.base_url).to eq("http://www.solacesystems.com/SEMP/v2/config")
    end
