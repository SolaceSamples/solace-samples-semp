...
# Unit tests for SempClient::AclProfileApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AclProfileApi' do
  before do
    # run before each test
    @instance = SempClient::AclProfileApi.new
  end
  ...
  describe 'test an instance of AclProfileApi' do
    it 'should create an instact of AclProfileApi' do
      expect(@instance).to be_instance_of(SempClient::AclProfileApi)
    end
  end
