...
# Unit tests for SempClient::AuthorizationGroupApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthorizationGroupApi' do
  before do
    # run before each test
    @instance = SempClient::AuthorizationGroupApi.new
  end
  ...
  describe 'test an instance of AuthorizationGroupApi' do
    it 'should create an instact of AuthorizationGroupApi' do
      expect(@instance).to be_instance_of(SempClient::AuthorizationGroupApi)
    end
  end
