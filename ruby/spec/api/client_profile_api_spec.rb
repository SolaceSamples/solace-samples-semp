...
# Unit tests for SempClient::ClientProfileApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ClientProfileApi' do
  before do
    # run before each test
    @instance = SempClient::ClientProfileApi.new
  end
  ...
  describe 'test an instance of ClientProfileApi' do
    it 'should create an instact of ClientProfileApi' do
      expect(@instance).to be_instance_of(SempClient::ClientProfileApi)
    end
  end
