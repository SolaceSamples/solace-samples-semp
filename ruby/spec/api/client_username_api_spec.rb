...
# Unit tests for SempClient::ClientUsernameApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ClientUsernameApi' do
  before do
    # run before each test
    @instance = SempClient::ClientUsernameApi.new
  end
  ...
  describe 'test an instance of ClientUsernameApi' do
    it 'should create an instact of ClientUsernameApi' do
      expect(@instance).to be_instance_of(SempClient::ClientUsernameApi)
    end
  end
