...
# Unit tests for SempClient::BridgeApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BridgeApi' do
  before do
    # run before each test
    @instance = SempClient::BridgeApi.new
  end
  ...
  describe 'test an instance of BridgeApi' do
    it 'should create an instact of BridgeApi' do
      expect(@instance).to be_instance_of(SempClient::BridgeApi)
    end
  end
