...
# Unit tests for SempClient::MsgVpnAclProfilePublishExceptionLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfilePublishExceptionLinks' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAclProfilePublishExceptionLinks.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfilePublishExceptionLinks' do
    it 'should create an instact of MsgVpnAclProfilePublishExceptionLinks' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAclProfilePublishExceptionLinks)
    end
  end
