...
# Unit tests for SempClient::MsgVpnAuthorizationGroupResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAuthorizationGroupResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAuthorizationGroupResponse.new
  end
  ...
  describe 'test an instance of MsgVpnAuthorizationGroupResponse' do
    it 'should create an instact of MsgVpnAuthorizationGroupResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAuthorizationGroupResponse)
    end
  end
