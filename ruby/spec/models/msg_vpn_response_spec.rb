...
# Unit tests for SempClient::MsgVpnResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnResponse.new
  end
  ...
  describe 'test an instance of MsgVpnResponse' do
    it 'should create an instact of MsgVpnResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnResponse)
    end
  end
