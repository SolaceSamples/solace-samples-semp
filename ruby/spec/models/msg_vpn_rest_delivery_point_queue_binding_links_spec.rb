...
# Unit tests for SempClient::MsgVpnRestDeliveryPointQueueBindingLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointQueueBindingLinks' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnRestDeliveryPointQueueBindingLinks.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointQueueBindingLinks' do
    it 'should create an instact of MsgVpnRestDeliveryPointQueueBindingLinks' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnRestDeliveryPointQueueBindingLinks)
    end
  end
