...
# Unit tests for SempClient::MsgVpnQueueResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnQueueResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnQueueResponse.new
  end
  ...
  describe 'test an instance of MsgVpnQueueResponse' do
    it 'should create an instact of MsgVpnQueueResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnQueueResponse)
    end
  end
