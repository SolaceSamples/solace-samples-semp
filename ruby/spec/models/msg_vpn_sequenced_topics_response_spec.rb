...
# Unit tests for SempClient::MsgVpnSequencedTopicsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnSequencedTopicsResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnSequencedTopicsResponse.new
  end
  ...
  describe 'test an instance of MsgVpnSequencedTopicsResponse' do
    it 'should create an instact of MsgVpnSequencedTopicsResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnSequencedTopicsResponse)
    end
  end
