...
# Unit tests for SempClient::MsgVpnBridgeRemoteMsgVpnsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeRemoteMsgVpnsResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnBridgeRemoteMsgVpnsResponse.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeRemoteMsgVpnsResponse' do
    it 'should create an instact of MsgVpnBridgeRemoteMsgVpnsResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnBridgeRemoteMsgVpnsResponse)
    end
  end
