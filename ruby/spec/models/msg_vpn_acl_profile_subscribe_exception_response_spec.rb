...
# Unit tests for SempClient::MsgVpnAclProfileSubscribeExceptionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfileSubscribeExceptionResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAclProfileSubscribeExceptionResponse.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfileSubscribeExceptionResponse' do
    it 'should create an instact of MsgVpnAclProfileSubscribeExceptionResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAclProfileSubscribeExceptionResponse)
    end
  end
