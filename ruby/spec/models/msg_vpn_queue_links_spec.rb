...
# Unit tests for SempClient::MsgVpnQueueLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnQueueLinks' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnQueueLinks.new
  end
  ...
  describe 'test an instance of MsgVpnQueueLinks' do
    it 'should create an instact of MsgVpnQueueLinks' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnQueueLinks)
    end
  end
  describe 'test attribute "subscriptions_uri"' do
    it 'should work' do
