...
# Unit tests for SempClient::MsgVpnQueueSubscriptionLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnQueueSubscriptionLinks' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnQueueSubscriptionLinks.new
  end
  ...
  describe 'test an instance of MsgVpnQueueSubscriptionLinks' do
    it 'should create an instact of MsgVpnQueueSubscriptionLinks' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnQueueSubscriptionLinks)
    end
  end
