...
# Unit tests for SempClient::MsgVpnAclProfileClientConnectExceptionLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfileClientConnectExceptionLinks' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAclProfileClientConnectExceptionLinks.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfileClientConnectExceptionLinks' do
    it 'should create an instact of MsgVpnAclProfileClientConnectExceptionLinks' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAclProfileClientConnectExceptionLinks)
    end
  end
