...
# Unit tests for SempClient::MsgVpnClientProfilesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnClientProfilesResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnClientProfilesResponse.new
  end
  ...
  describe 'test an instance of MsgVpnClientProfilesResponse' do
    it 'should create an instact of MsgVpnClientProfilesResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnClientProfilesResponse)
    end
  end
