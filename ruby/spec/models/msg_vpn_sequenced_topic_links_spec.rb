...
# Unit tests for SempClient::MsgVpnSequencedTopicLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnSequencedTopicLinks' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnSequencedTopicLinks.new
  end
  ...
  describe 'test an instance of MsgVpnSequencedTopicLinks' do
    it 'should create an instact of MsgVpnSequencedTopicLinks' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnSequencedTopicLinks)
    end
  end
