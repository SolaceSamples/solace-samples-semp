...
# Unit tests for SempClient::MsgVpnClientUsernameLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnClientUsernameLinks' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnClientUsernameLinks.new
  end
  ...
  describe 'test an instance of MsgVpnClientUsernameLinks' do
    it 'should create an instact of MsgVpnClientUsernameLinks' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnClientUsernameLinks)
    end
  end
