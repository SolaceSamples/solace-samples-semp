...
# Unit tests for SempClient::MsgVpnRestDeliveryPointRestConsumerResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointRestConsumerResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnRestDeliveryPointRestConsumerResponse.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointRestConsumerResponse' do
    it 'should create an instact of MsgVpnRestDeliveryPointRestConsumerResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnRestDeliveryPointRestConsumerResponse)
    end
  end
