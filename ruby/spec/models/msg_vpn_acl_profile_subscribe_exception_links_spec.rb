...
# Unit tests for SempClient::MsgVpnAclProfileSubscribeExceptionLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfileSubscribeExceptionLinks' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAclProfileSubscribeExceptionLinks.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfileSubscribeExceptionLinks' do
    it 'should create an instact of MsgVpnAclProfileSubscribeExceptionLinks' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAclProfileSubscribeExceptionLinks)
    end
  end
