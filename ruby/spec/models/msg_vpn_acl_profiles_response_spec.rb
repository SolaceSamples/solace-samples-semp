...
# Unit tests for SempClient::MsgVpnAclProfilesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfilesResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAclProfilesResponse.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfilesResponse' do
    it 'should create an instact of MsgVpnAclProfilesResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAclProfilesResponse)
    end
  end
