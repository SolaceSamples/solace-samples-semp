...
# Unit tests for SempClient::SempRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SempRequest' do
  before do
    # run before each test
    @instance = SempClient::SempRequest.new
  end
  ...
  describe 'test an instance of SempRequest' do
    it 'should create an instact of SempRequest' do
      expect(@instance).to be_instance_of(SempClient::SempRequest)
    end
  end
