...
# Unit tests for SempClient::MsgVpnRestDeliveryPointLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointLinks' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnRestDeliveryPointLinks.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointLinks' do
    it 'should create an instact of MsgVpnRestDeliveryPointLinks' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnRestDeliveryPointLinks)
    end
  end
  describe 'test attribute "queue_bindings_uri"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "rest_consumers_uri"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
