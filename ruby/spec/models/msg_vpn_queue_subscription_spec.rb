...
# Unit tests for SempClient::MsgVpnQueueSubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnQueueSubscription' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnQueueSubscription.new
  end
  ...
  describe 'test an instance of MsgVpnQueueSubscription' do
    it 'should create an instact of MsgVpnQueueSubscription' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnQueueSubscription)
    end
  end
  ...
  describe 'test attribute "subscription_topic"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
