...
# Unit tests for SempClient::MsgVpnsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnsResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnsResponse.new
  end
  ...
  describe 'test an instance of MsgVpnsResponse' do
    it 'should create an instact of MsgVpnsResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnsResponse)
    end
  end
