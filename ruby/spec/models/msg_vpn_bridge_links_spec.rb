...
# Unit tests for SempClient::MsgVpnBridgeLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeLinks' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnBridgeLinks.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeLinks' do
    it 'should create an instact of MsgVpnBridgeLinks' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnBridgeLinks)
    end
  end
  describe 'test attribute "remote_msg_vpns_uri"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "remote_subscriptions_uri"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
