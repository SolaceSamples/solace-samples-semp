...
# Unit tests for SempClient::SempMeta
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SempMeta' do
  before do
    # run before each test
    @instance = SempClient::SempMeta.new
  end
  ...
  describe 'test an instance of SempMeta' do
    it 'should create an instact of SempMeta' do
      expect(@instance).to be_instance_of(SempClient::SempMeta)
    end
  end
