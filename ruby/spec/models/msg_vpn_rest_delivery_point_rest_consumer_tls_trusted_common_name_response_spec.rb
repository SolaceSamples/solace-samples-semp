...
# Unit tests for SempClient::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse' do
    it 'should create an instact of MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse)
    end
  end
