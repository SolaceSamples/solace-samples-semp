...
# Unit tests for SempClient::MsgVpnAclProfileResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfileResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAclProfileResponse.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfileResponse' do
    it 'should create an instact of MsgVpnAclProfileResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAclProfileResponse)
    end
  end
