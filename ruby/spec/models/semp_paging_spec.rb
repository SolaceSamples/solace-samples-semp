...
# Unit tests for SempClient::SempPaging
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SempPaging' do
  before do
    # run before each test
    @instance = SempClient::SempPaging.new
  end
  ...
  describe 'test an instance of SempPaging' do
    it 'should create an instact of SempPaging' do
      expect(@instance).to be_instance_of(SempClient::SempPaging)
    end
  end
  describe 'test attribute "cursor_query"' do
    it 'should work' do
