...
# Unit tests for SempClient::MsgVpnAuthorizationGroupLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAuthorizationGroupLinks' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAuthorizationGroupLinks.new
  end
  ...
  describe 'test an instance of MsgVpnAuthorizationGroupLinks' do
    it 'should create an instact of MsgVpnAuthorizationGroupLinks' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAuthorizationGroupLinks)
    end
  end
