...
# Unit tests for SempClient::MsgVpnAclProfilePublishExceptionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfilePublishExceptionResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAclProfilePublishExceptionResponse.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfilePublishExceptionResponse' do
    it 'should create an instact of MsgVpnAclProfilePublishExceptionResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAclProfilePublishExceptionResponse)
    end
  end
