...
# Unit tests for SempClient::MsgVpnBridgeRemoteSubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeRemoteSubscription' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnBridgeRemoteSubscription.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeRemoteSubscription' do
    it 'should create an instact of MsgVpnBridgeRemoteSubscription' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnBridgeRemoteSubscription)
    end
  end
  ...
  describe 'test attribute "deliver_always_enabled"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "remote_subscription_topic"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
