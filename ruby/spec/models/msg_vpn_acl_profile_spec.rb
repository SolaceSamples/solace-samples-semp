...
# Unit tests for SempClient::MsgVpnAclProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfile' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAclProfile.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfile' do
    it 'should create an instact of MsgVpnAclProfile' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAclProfile)
    end
  end
  describe 'test attribute "acl_profile_name"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "client_connect_default_action"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["allow", "disallow"])
       #validator.allowable_values.each do |value|
       #  expect { @instance.client_connect_default_action = value }.not_to raise_error
       #end
    end
  end
  ...
  describe 'test attribute "publish_topic_default_action"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["allow", "disallow"])
       #validator.allowable_values.each do |value|
       #  expect { @instance.publish_topic_default_action = value }.not_to raise_error
       #end
    end
  end

  describe 'test attribute "subscribe_topic_default_action"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["allow", "disallow"])
       #validator.allowable_values.each do |value|
       #  expect { @instance.subscribe_topic_default_action = value }.not_to raise_error
       #end
    end
  end
