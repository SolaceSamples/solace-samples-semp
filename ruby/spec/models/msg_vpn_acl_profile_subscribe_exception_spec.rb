...
# Unit tests for SempClient::MsgVpnAclProfileSubscribeException
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfileSubscribeException' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAclProfileSubscribeException.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfileSubscribeException' do
    it 'should create an instact of MsgVpnAclProfileSubscribeException' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAclProfileSubscribeException)
    end
  end
  ...
  describe 'test attribute "subscribe_exception_topic"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "topic_syntax"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["smf", "mqtt"])
       #validator.allowable_values.each do |value|
       #  expect { @instance.topic_syntax = value }.not_to raise_error
       #end
    end
  end
