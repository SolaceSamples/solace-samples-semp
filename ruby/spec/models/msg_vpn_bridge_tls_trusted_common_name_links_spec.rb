...
# Unit tests for SempClient::MsgVpnBridgeTlsTrustedCommonNameLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeTlsTrustedCommonNameLinks' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnBridgeTlsTrustedCommonNameLinks.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeTlsTrustedCommonNameLinks' do
    it 'should create an instact of MsgVpnBridgeTlsTrustedCommonNameLinks' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnBridgeTlsTrustedCommonNameLinks)
    end
  end
