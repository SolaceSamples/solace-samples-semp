...
# Unit tests for SempClient::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks' do
    it 'should create an instact of MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks)
    end
  end
