...
# Unit tests for SempClient::MsgVpnAclProfileSubscribeExceptionsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfileSubscribeExceptionsResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAclProfileSubscribeExceptionsResponse.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfileSubscribeExceptionsResponse' do
    it 'should create an instact of MsgVpnAclProfileSubscribeExceptionsResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAclProfileSubscribeExceptionsResponse)
    end
  end
