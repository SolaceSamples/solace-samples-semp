...
# Unit tests for SempClient::MsgVpnBridgeTlsTrustedCommonNameResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeTlsTrustedCommonNameResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnBridgeTlsTrustedCommonNameResponse.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeTlsTrustedCommonNameResponse' do
    it 'should create an instact of MsgVpnBridgeTlsTrustedCommonNameResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnBridgeTlsTrustedCommonNameResponse)
    end
  end
