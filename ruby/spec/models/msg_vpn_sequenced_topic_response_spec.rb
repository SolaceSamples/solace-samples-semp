...
# Unit tests for SempClient::MsgVpnSequencedTopicResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnSequencedTopicResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnSequencedTopicResponse.new
  end
  ...
  describe 'test an instance of MsgVpnSequencedTopicResponse' do
    it 'should create an instact of MsgVpnSequencedTopicResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnSequencedTopicResponse)
    end
  end
