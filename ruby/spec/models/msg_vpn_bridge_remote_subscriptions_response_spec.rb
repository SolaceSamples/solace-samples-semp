...
# Unit tests for SempClient::MsgVpnBridgeRemoteSubscriptionsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeRemoteSubscriptionsResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnBridgeRemoteSubscriptionsResponse.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeRemoteSubscriptionsResponse' do
    it 'should create an instact of MsgVpnBridgeRemoteSubscriptionsResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnBridgeRemoteSubscriptionsResponse)
    end
  end
