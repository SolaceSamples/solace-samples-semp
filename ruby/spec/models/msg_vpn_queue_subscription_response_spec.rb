...
# Unit tests for SempClient::MsgVpnQueueSubscriptionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnQueueSubscriptionResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnQueueSubscriptionResponse.new
  end
  ...
  describe 'test an instance of MsgVpnQueueSubscriptionResponse' do
    it 'should create an instact of MsgVpnQueueSubscriptionResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnQueueSubscriptionResponse)
    end
  end
