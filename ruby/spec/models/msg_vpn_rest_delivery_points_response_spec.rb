...
# Unit tests for SempClient::MsgVpnRestDeliveryPointsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointsResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnRestDeliveryPointsResponse.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointsResponse' do
    it 'should create an instact of MsgVpnRestDeliveryPointsResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnRestDeliveryPointsResponse)
    end
  end
