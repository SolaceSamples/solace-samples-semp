...
# Unit tests for SempClient::SempError
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SempError' do
  before do
    # run before each test
    @instance = SempClient::SempError.new
  end
  ...
  describe 'test an instance of SempError' do
    it 'should create an instact of SempError' do
      expect(@instance).to be_instance_of(SempClient::SempError)
    end
  end
