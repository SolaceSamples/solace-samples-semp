...
# Unit tests for SempClient::MsgVpnBridgeRemoteSubscriptionLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeRemoteSubscriptionLinks' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnBridgeRemoteSubscriptionLinks.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeRemoteSubscriptionLinks' do
    it 'should create an instact of MsgVpnBridgeRemoteSubscriptionLinks' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnBridgeRemoteSubscriptionLinks)
    end
  end
