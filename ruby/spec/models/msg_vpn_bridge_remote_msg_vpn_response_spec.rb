...
# Unit tests for SempClient::MsgVpnBridgeRemoteMsgVpnResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeRemoteMsgVpnResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnBridgeRemoteMsgVpnResponse.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeRemoteMsgVpnResponse' do
    it 'should create an instact of MsgVpnBridgeRemoteMsgVpnResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnBridgeRemoteMsgVpnResponse)
    end
  end
