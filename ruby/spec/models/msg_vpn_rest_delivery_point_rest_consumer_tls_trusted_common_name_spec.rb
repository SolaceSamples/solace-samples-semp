...
# Unit tests for SempClient::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName' do
    it 'should create an instact of MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName)
    end
  end
  ...
  describe 'test attribute "tls_trusted_common_name"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
