...
# Unit tests for SempClient::SempMetaOnlyResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SempMetaOnlyResponse' do
  before do
    # run before each test
    @instance = SempClient::SempMetaOnlyResponse.new
  end
  ...
  describe 'test an instance of SempMetaOnlyResponse' do
    it 'should create an instact of SempMetaOnlyResponse' do
      expect(@instance).to be_instance_of(SempClient::SempMetaOnlyResponse)
    end
  end
