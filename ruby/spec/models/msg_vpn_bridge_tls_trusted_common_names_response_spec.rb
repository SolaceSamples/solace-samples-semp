...
# Unit tests for SempClient::MsgVpnBridgeTlsTrustedCommonNamesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeTlsTrustedCommonNamesResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnBridgeTlsTrustedCommonNamesResponse.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeTlsTrustedCommonNamesResponse' do
    it 'should create an instact of MsgVpnBridgeTlsTrustedCommonNamesResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnBridgeTlsTrustedCommonNamesResponse)
    end
  end
