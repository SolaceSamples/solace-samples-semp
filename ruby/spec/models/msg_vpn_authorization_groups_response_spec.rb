...
# Unit tests for SempClient::MsgVpnAuthorizationGroupsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAuthorizationGroupsResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAuthorizationGroupsResponse.new
  end
  ...
  describe 'test an instance of MsgVpnAuthorizationGroupsResponse' do
    it 'should create an instact of MsgVpnAuthorizationGroupsResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAuthorizationGroupsResponse)
    end
  end
