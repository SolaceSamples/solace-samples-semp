...
# Unit tests for SempClient::MsgVpnBridgeTlsTrustedCommonName
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeTlsTrustedCommonName' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnBridgeTlsTrustedCommonName.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeTlsTrustedCommonName' do
    it 'should create an instact of MsgVpnBridgeTlsTrustedCommonName' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnBridgeTlsTrustedCommonName)
    end
  end
