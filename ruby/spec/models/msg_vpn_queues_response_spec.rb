...
# Unit tests for SempClient::MsgVpnQueuesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnQueuesResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnQueuesResponse.new
  end
  ...
  describe 'test an instance of MsgVpnQueuesResponse' do
    it 'should create an instact of MsgVpnQueuesResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnQueuesResponse)
    end
  end
