...
# Unit tests for SempClient::EventThresholdByValue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EventThresholdByValue' do
  before do
    # run before each test
    @instance = SempClient::EventThresholdByValue.new
  end
  ...
  describe 'test an instance of EventThresholdByValue' do
    it 'should create an instact of EventThresholdByValue' do
      expect(@instance).to be_instance_of(SempClient::EventThresholdByValue)
    end
  end
