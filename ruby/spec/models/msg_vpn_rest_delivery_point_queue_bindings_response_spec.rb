...
# Unit tests for SempClient::MsgVpnRestDeliveryPointQueueBindingsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointQueueBindingsResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnRestDeliveryPointQueueBindingsResponse.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointQueueBindingsResponse' do
    it 'should create an instact of MsgVpnRestDeliveryPointQueueBindingsResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnRestDeliveryPointQueueBindingsResponse)
    end
  end
