...
# Unit tests for SempClient::MsgVpnBridge
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridge' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnBridge.new
  end
  ...
  describe 'test an instance of MsgVpnBridge' do
    it 'should create an instact of MsgVpnBridge' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnBridge)
    end
  end
  describe 'test attribute "bridge_name"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "bridge_virtual_router"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["primary", "backup"])
       #validator.allowable_values.each do |value|
       #  expect { @instance.bridge_virtual_router = value }.not_to raise_error
       #end
    end
  end
  ...
  describe 'test attribute "remote_authentication_basic_client_username"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "remote_authentication_basic_password"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "remote_authentication_scheme"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["basic", "client-certificate"])
       #validator.allowable_values.each do |value|
       #  expect { @instance.remote_authentication_scheme = value }.not_to raise_error
       #end
    end
  end

  describe 'test attribute "remote_connection_retry_count"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "remote_connection_retry_delay"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "remote_deliver_to_one_priority"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["p1", "p2", "p3", "p4", "da"])
       #validator.allowable_values.each do |value|
       #  expect { @instance.remote_deliver_to_one_priority = value }.not_to raise_error
       #end
    end
  end

  describe 'test attribute "tls_cipher_suite_list"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
