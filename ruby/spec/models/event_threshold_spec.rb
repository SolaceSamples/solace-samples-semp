...
# Unit tests for SempClient::EventThreshold
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EventThreshold' do
  before do
    # run before each test
    @instance = SempClient::EventThreshold.new
  end
  ...
  describe 'test an instance of EventThreshold' do
    it 'should create an instact of EventThreshold' do
      expect(@instance).to be_instance_of(SempClient::EventThreshold)
    end
  end
  describe 'test attribute "clear_percent"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "clear_value"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "set_percent"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "set_value"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
