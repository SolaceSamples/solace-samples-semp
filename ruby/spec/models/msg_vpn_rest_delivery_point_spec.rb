...
# Unit tests for SempClient::MsgVpnRestDeliveryPoint
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPoint' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnRestDeliveryPoint.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPoint' do
    it 'should create an instact of MsgVpnRestDeliveryPoint' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnRestDeliveryPoint)
    end
  end
