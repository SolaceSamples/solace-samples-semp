...
# Unit tests for SempClient::MsgVpnClientUsernamesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnClientUsernamesResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnClientUsernamesResponse.new
  end
  ...
  describe 'test an instance of MsgVpnClientUsernamesResponse' do
    it 'should create an instact of MsgVpnClientUsernamesResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnClientUsernamesResponse)
    end
  end
