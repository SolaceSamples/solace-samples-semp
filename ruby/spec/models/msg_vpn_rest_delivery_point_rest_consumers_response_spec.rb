...
# Unit tests for SempClient::MsgVpnRestDeliveryPointRestConsumersResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointRestConsumersResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnRestDeliveryPointRestConsumersResponse.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointRestConsumersResponse' do
    it 'should create an instact of MsgVpnRestDeliveryPointRestConsumersResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnRestDeliveryPointRestConsumersResponse)
    end
  end
