...
# Unit tests for SempClient::MsgVpnRestDeliveryPointResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnRestDeliveryPointResponse.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointResponse' do
    it 'should create an instact of MsgVpnRestDeliveryPointResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnRestDeliveryPointResponse)
    end
  end
