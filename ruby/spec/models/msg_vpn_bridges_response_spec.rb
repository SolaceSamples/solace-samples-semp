...
# Unit tests for SempClient::MsgVpnBridgesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgesResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnBridgesResponse.new
  end
  ...
  describe 'test an instance of MsgVpnBridgesResponse' do
    it 'should create an instact of MsgVpnBridgesResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnBridgesResponse)
    end
  end
