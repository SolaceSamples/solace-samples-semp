...
# Unit tests for SempClient::MsgVpnAclProfileClientConnectException
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfileClientConnectException' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAclProfileClientConnectException.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfileClientConnectException' do
    it 'should create an instact of MsgVpnAclProfileClientConnectException' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAclProfileClientConnectException)
    end
  end
  ...
  describe 'test attribute "client_connect_exception_address"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
