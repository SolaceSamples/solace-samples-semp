...
# Unit tests for SempClient::MsgVpnQueueSubscriptionsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnQueueSubscriptionsResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnQueueSubscriptionsResponse.new
  end
  ...
  describe 'test an instance of MsgVpnQueueSubscriptionsResponse' do
    it 'should create an instact of MsgVpnQueueSubscriptionsResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnQueueSubscriptionsResponse)
    end
  end
