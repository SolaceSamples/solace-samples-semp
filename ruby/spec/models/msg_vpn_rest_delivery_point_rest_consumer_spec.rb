...
# Unit tests for SempClient::MsgVpnRestDeliveryPointRestConsumer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointRestConsumer' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnRestDeliveryPointRestConsumer.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointRestConsumer' do
    it 'should create an instact of MsgVpnRestDeliveryPointRestConsumer' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnRestDeliveryPointRestConsumer)
    end
  end
  describe 'test attribute "authentication_http_basic_password"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "authentication_http_basic_username"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "authentication_scheme"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["none", "http-basic", "client-certificate"])
       #validator.allowable_values.each do |value|
       #  expect { @instance.authentication_scheme = value }.not_to raise_error
       #end
    end
  end
  ...
  describe 'test attribute "local_interface"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "max_post_wait_time"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "outgoing_connection_count"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "rest_consumer_name"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "rest_delivery_point_name"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
