...
# Unit tests for SempClient::MsgVpnRestDeliveryPointRestConsumerLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointRestConsumerLinks' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnRestDeliveryPointRestConsumerLinks.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointRestConsumerLinks' do
    it 'should create an instact of MsgVpnRestDeliveryPointRestConsumerLinks' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnRestDeliveryPointRestConsumerLinks)
    end
  end
  describe 'test attribute "tls_trusted_common_names_uri"' do
    it 'should work' do
