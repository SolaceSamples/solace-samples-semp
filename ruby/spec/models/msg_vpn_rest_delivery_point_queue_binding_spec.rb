...
# Unit tests for SempClient::MsgVpnRestDeliveryPointQueueBinding
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointQueueBinding' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnRestDeliveryPointQueueBinding.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointQueueBinding' do
    it 'should create an instact of MsgVpnRestDeliveryPointQueueBinding' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnRestDeliveryPointQueueBinding)
    end
  end
  ...
  describe 'test attribute "post_request_target"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "queue_binding_name"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
