...
# Unit tests for SempClient::MsgVpnSequencedTopic
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnSequencedTopic' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnSequencedTopic.new
  end
  ...
  describe 'test an instance of MsgVpnSequencedTopic' do
    it 'should create an instact of MsgVpnSequencedTopic' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnSequencedTopic)
    end
  end
  ...
  describe 'test attribute "sequenced_topic"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
