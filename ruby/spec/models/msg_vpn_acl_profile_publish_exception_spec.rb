...
# Unit tests for SempClient::MsgVpnAclProfilePublishException
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfilePublishException' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAclProfilePublishException.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfilePublishException' do
    it 'should create an instact of MsgVpnAclProfilePublishException' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAclProfilePublishException)
    end
  end
  ...
  describe 'test attribute "publish_exception_topic"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
