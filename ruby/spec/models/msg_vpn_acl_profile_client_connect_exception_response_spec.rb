...
# Unit tests for SempClient::MsgVpnAclProfileClientConnectExceptionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfileClientConnectExceptionResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAclProfileClientConnectExceptionResponse.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfileClientConnectExceptionResponse' do
    it 'should create an instact of MsgVpnAclProfileClientConnectExceptionResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAclProfileClientConnectExceptionResponse)
    end
  end
