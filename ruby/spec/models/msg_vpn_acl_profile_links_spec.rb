...
# Unit tests for SempClient::MsgVpnAclProfileLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfileLinks' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAclProfileLinks.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfileLinks' do
    it 'should create an instact of MsgVpnAclProfileLinks' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAclProfileLinks)
    end
  end
  describe 'test attribute "client_connect_exceptions_uri"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "publish_exceptions_uri"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "subscribe_exceptions_uri"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
