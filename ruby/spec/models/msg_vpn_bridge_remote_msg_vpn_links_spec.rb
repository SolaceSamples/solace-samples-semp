...
# Unit tests for SempClient::MsgVpnBridgeRemoteMsgVpnLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeRemoteMsgVpnLinks' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnBridgeRemoteMsgVpnLinks.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeRemoteMsgVpnLinks' do
    it 'should create an instact of MsgVpnBridgeRemoteMsgVpnLinks' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnBridgeRemoteMsgVpnLinks)
    end
  end
