...
# Unit tests for SempClient::MsgVpnAclProfileClientConnectExceptionsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfileClientConnectExceptionsResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAclProfileClientConnectExceptionsResponse.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfileClientConnectExceptionsResponse' do
    it 'should create an instact of MsgVpnAclProfileClientConnectExceptionsResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAclProfileClientConnectExceptionsResponse)
    end
  end
