...
# Unit tests for SempClient::MsgVpnClientUsernameResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnClientUsernameResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnClientUsernameResponse.new
  end
  ...
  describe 'test an instance of MsgVpnClientUsernameResponse' do
    it 'should create an instact of MsgVpnClientUsernameResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnClientUsernameResponse)
    end
  end
