...
# Unit tests for SempClient::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse' do
    it 'should create an instact of MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse)
    end
  end
