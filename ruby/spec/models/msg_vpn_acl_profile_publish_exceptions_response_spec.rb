...
# Unit tests for SempClient::MsgVpnAclProfilePublishExceptionsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfilePublishExceptionsResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnAclProfilePublishExceptionsResponse.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfilePublishExceptionsResponse' do
    it 'should create an instact of MsgVpnAclProfilePublishExceptionsResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnAclProfilePublishExceptionsResponse)
    end
  end
