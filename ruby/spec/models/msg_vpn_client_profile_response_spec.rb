...
# Unit tests for SempClient::MsgVpnClientProfileResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnClientProfileResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnClientProfileResponse.new
  end
  ...
  describe 'test an instance of MsgVpnClientProfileResponse' do
    it 'should create an instact of MsgVpnClientProfileResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnClientProfileResponse)
    end
  end
