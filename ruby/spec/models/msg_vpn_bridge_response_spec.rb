...
# Unit tests for SempClient::MsgVpnBridgeResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnBridgeResponse.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeResponse' do
    it 'should create an instact of MsgVpnBridgeResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnBridgeResponse)
    end
  end
