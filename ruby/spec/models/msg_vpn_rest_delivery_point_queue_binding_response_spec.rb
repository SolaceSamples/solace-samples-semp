...
# Unit tests for SempClient::MsgVpnRestDeliveryPointQueueBindingResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointQueueBindingResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnRestDeliveryPointQueueBindingResponse.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointQueueBindingResponse' do
    it 'should create an instact of MsgVpnRestDeliveryPointQueueBindingResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnRestDeliveryPointQueueBindingResponse)
    end
  end
