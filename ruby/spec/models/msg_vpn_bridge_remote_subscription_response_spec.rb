...
# Unit tests for SempClient::MsgVpnBridgeRemoteSubscriptionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeRemoteSubscriptionResponse' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnBridgeRemoteSubscriptionResponse.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeRemoteSubscriptionResponse' do
    it 'should create an instact of MsgVpnBridgeRemoteSubscriptionResponse' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnBridgeRemoteSubscriptionResponse)
    end
  end
