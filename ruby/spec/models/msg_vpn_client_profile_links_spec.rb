...
# Unit tests for SempClient::MsgVpnClientProfileLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnClientProfileLinks' do
  before do
    # run before each test
    @instance = SempClient::MsgVpnClientProfileLinks.new
  end
  ...
  describe 'test an instance of MsgVpnClientProfileLinks' do
    it 'should create an instact of MsgVpnClientProfileLinks' do
      expect(@instance).to be_instance_of(SempClient::MsgVpnClientProfileLinks)
    end
  end
