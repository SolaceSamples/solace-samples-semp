...
# Unit tests for SempClient::EventThresholdByPercent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EventThresholdByPercent' do
  before do
    # run before each test
    @instance = SempClient::EventThresholdByPercent.new
  end
  ...
  describe 'test an instance of EventThresholdByPercent' do
    it 'should create an instact of EventThresholdByPercent' do
      expect(@instance).to be_instance_of(SempClient::EventThresholdByPercent)
    end
  end
