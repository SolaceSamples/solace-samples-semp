...
Gem::Specification.new do |s|
  s.name        = "semp_client"
  s.version     = SempClient::VERSION
  s.platform    = Gem::Platform::RUBY
  s.authors     = ["Solace Corporation"]
  s.email       = ["support_request@solace.com"]
  s.homepage    = "http://solace.com"
  s.summary     = "SEMP Ruby Client Library"
  s.description = "This gem maps to the SEMP API used for configuring the Solace message router"
