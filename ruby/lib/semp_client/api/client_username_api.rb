  ...
  class ClientUsernameApi
    ...
    def create_msg_vpn_client_username_with_http_info(msg_vpn_name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ClientUsernameApi.create_msg_vpn_client_username ..."
      end
      # verify the required parameter 'msg_vpn_name' is set
      fail ArgumentError, "Missing the required parameter 'msg_vpn_name' when calling ClientUsernameApi.create_msg_vpn_client_username" if msg_vpn_name.nil?
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling ClientUsernameApi.create_msg_vpn_client_username" if body.nil?
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ClientUsernameApi#create_msg_vpn_client_username\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_msg_vpn_client_username_with_http_info(msg_vpn_name, client_username, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ClientUsernameApi.delete_msg_vpn_client_username ..."
      end
      # verify the required parameter 'msg_vpn_name' is set
      fail ArgumentError, "Missing the required parameter 'msg_vpn_name' when calling ClientUsernameApi.delete_msg_vpn_client_username" if msg_vpn_name.nil?
      # verify the required parameter 'client_username' is set
      fail ArgumentError, "Missing the required parameter 'client_username' when calling ClientUsernameApi.delete_msg_vpn_client_username" if client_username.nil?
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ClientUsernameApi#delete_msg_vpn_client_username\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_msg_vpn_client_username_with_http_info(msg_vpn_name, client_username, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ClientUsernameApi.get_msg_vpn_client_username ..."
      end
      # verify the required parameter 'msg_vpn_name' is set
      fail ArgumentError, "Missing the required parameter 'msg_vpn_name' when calling ClientUsernameApi.get_msg_vpn_client_username" if msg_vpn_name.nil?
      # verify the required parameter 'client_username' is set
      fail ArgumentError, "Missing the required parameter 'client_username' when calling ClientUsernameApi.get_msg_vpn_client_username" if client_username.nil?
      # resource path
      local_var_path = "/msgVpns/{msgVpnName}/clientUsernames/{clientUsername}".sub('{format}','json').sub('{' + 'msgVpnName' + '}', msg_vpn_name.to_s).sub('{' + 'clientUsername' + '}', client_username.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'MsgVpnClientUsernameResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ClientUsernameApi#get_msg_vpn_client_username\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_msg_vpn_client_usernames_with_http_info(msg_vpn_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ClientUsernameApi.get_msg_vpn_client_usernames ..."
      end
      # verify the required parameter 'msg_vpn_name' is set
      fail ArgumentError, "Missing the required parameter 'msg_vpn_name' when calling ClientUsernameApi.get_msg_vpn_client_usernames" if msg_vpn_name.nil?
      if !opts[:'count'].nil? && opts[:'count'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"count"]" when calling ClientUsernameApi.get_msg_vpn_client_usernames, must be greater than or equal to 1.0.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ClientUsernameApi#get_msg_vpn_client_usernames\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def replace_msg_vpn_client_username_with_http_info(msg_vpn_name, client_username, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ClientUsernameApi.replace_msg_vpn_client_username ..."
      end
      # verify the required parameter 'msg_vpn_name' is set
      fail ArgumentError, "Missing the required parameter 'msg_vpn_name' when calling ClientUsernameApi.replace_msg_vpn_client_username" if msg_vpn_name.nil?
      # verify the required parameter 'client_username' is set
      fail ArgumentError, "Missing the required parameter 'client_username' when calling ClientUsernameApi.replace_msg_vpn_client_username" if client_username.nil?
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling ClientUsernameApi.replace_msg_vpn_client_username" if body.nil?
      # resource path
      local_var_path = "/msgVpns/{msgVpnName}/clientUsernames/{clientUsername}".sub('{format}','json').sub('{' + 'msgVpnName' + '}', msg_vpn_name.to_s).sub('{' + 'clientUsername' + '}', client_username.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'MsgVpnClientUsernameResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ClientUsernameApi#replace_msg_vpn_client_username\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_msg_vpn_client_username_with_http_info(msg_vpn_name, client_username, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ClientUsernameApi.update_msg_vpn_client_username ..."
      end
      # verify the required parameter 'msg_vpn_name' is set
      fail ArgumentError, "Missing the required parameter 'msg_vpn_name' when calling ClientUsernameApi.update_msg_vpn_client_username" if msg_vpn_name.nil?
      # verify the required parameter 'client_username' is set
      fail ArgumentError, "Missing the required parameter 'client_username' when calling ClientUsernameApi.update_msg_vpn_client_username" if client_username.nil?
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling ClientUsernameApi.update_msg_vpn_client_username" if body.nil?
      # resource path
      local_var_path = "/msgVpns/{msgVpnName}/clientUsernames/{clientUsername}".sub('{format}','json').sub('{' + 'msgVpnName' + '}', msg_vpn_name.to_s).sub('{' + 'clientUsername' + '}', client_username.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path,
        ...
        :return_type => 'MsgVpnClientUsernameResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ClientUsernameApi#update_msg_vpn_client_username\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
