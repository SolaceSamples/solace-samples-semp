  ...
  class AuthorizationGroupApi
    ...
    def create_msg_vpn_authorization_group_with_http_info(msg_vpn_name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AuthorizationGroupApi.create_msg_vpn_authorization_group ..."
      end
      # verify the required parameter 'msg_vpn_name' is set
      fail ArgumentError, "Missing the required parameter 'msg_vpn_name' when calling AuthorizationGroupApi.create_msg_vpn_authorization_group" if msg_vpn_name.nil?
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling AuthorizationGroupApi.create_msg_vpn_authorization_group" if body.nil?
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuthorizationGroupApi#create_msg_vpn_authorization_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_msg_vpn_authorization_group_with_http_info(msg_vpn_name, authorization_group_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AuthorizationGroupApi.delete_msg_vpn_authorization_group ..."
      end
      # verify the required parameter 'msg_vpn_name' is set
      fail ArgumentError, "Missing the required parameter 'msg_vpn_name' when calling AuthorizationGroupApi.delete_msg_vpn_authorization_group" if msg_vpn_name.nil?
      # verify the required parameter 'authorization_group_name' is set
      fail ArgumentError, "Missing the required parameter 'authorization_group_name' when calling AuthorizationGroupApi.delete_msg_vpn_authorization_group" if authorization_group_name.nil?
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuthorizationGroupApi#delete_msg_vpn_authorization_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_msg_vpn_authorization_group_with_http_info(msg_vpn_name, authorization_group_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AuthorizationGroupApi.get_msg_vpn_authorization_group ..."
      end
      # verify the required parameter 'msg_vpn_name' is set
      fail ArgumentError, "Missing the required parameter 'msg_vpn_name' when calling AuthorizationGroupApi.get_msg_vpn_authorization_group" if msg_vpn_name.nil?
      # verify the required parameter 'authorization_group_name' is set
      fail ArgumentError, "Missing the required parameter 'authorization_group_name' when calling AuthorizationGroupApi.get_msg_vpn_authorization_group" if authorization_group_name.nil?
      # resource path
      local_var_path = "/msgVpns/{msgVpnName}/authorizationGroups/{authorizationGroupName}".sub('{format}','json').sub('{' + 'msgVpnName' + '}', msg_vpn_name.to_s).sub('{' + 'authorizationGroupName' + '}', authorization_group_name.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'MsgVpnAuthorizationGroupResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuthorizationGroupApi#get_msg_vpn_authorization_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_msg_vpn_authorization_groups_with_http_info(msg_vpn_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AuthorizationGroupApi.get_msg_vpn_authorization_groups ..."
      end
      # verify the required parameter 'msg_vpn_name' is set
      fail ArgumentError, "Missing the required parameter 'msg_vpn_name' when calling AuthorizationGroupApi.get_msg_vpn_authorization_groups" if msg_vpn_name.nil?
      if !opts[:'count'].nil? && opts[:'count'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"count"]" when calling AuthorizationGroupApi.get_msg_vpn_authorization_groups, must be greater than or equal to 1.0.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuthorizationGroupApi#get_msg_vpn_authorization_groups\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def replace_msg_vpn_authorization_group_with_http_info(msg_vpn_name, authorization_group_name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AuthorizationGroupApi.replace_msg_vpn_authorization_group ..."
      end
      # verify the required parameter 'msg_vpn_name' is set
      fail ArgumentError, "Missing the required parameter 'msg_vpn_name' when calling AuthorizationGroupApi.replace_msg_vpn_authorization_group" if msg_vpn_name.nil?
      # verify the required parameter 'authorization_group_name' is set
      fail ArgumentError, "Missing the required parameter 'authorization_group_name' when calling AuthorizationGroupApi.replace_msg_vpn_authorization_group" if authorization_group_name.nil?
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling AuthorizationGroupApi.replace_msg_vpn_authorization_group" if body.nil?
      # resource path
      local_var_path = "/msgVpns/{msgVpnName}/authorizationGroups/{authorizationGroupName}".sub('{format}','json').sub('{' + 'msgVpnName' + '}', msg_vpn_name.to_s).sub('{' + 'authorizationGroupName' + '}', authorization_group_name.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'MsgVpnAuthorizationGroupResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuthorizationGroupApi#replace_msg_vpn_authorization_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_msg_vpn_authorization_group_with_http_info(msg_vpn_name, authorization_group_name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AuthorizationGroupApi.update_msg_vpn_authorization_group ..."
      end
      # verify the required parameter 'msg_vpn_name' is set
      fail ArgumentError, "Missing the required parameter 'msg_vpn_name' when calling AuthorizationGroupApi.update_msg_vpn_authorization_group" if msg_vpn_name.nil?
      # verify the required parameter 'authorization_group_name' is set
      fail ArgumentError, "Missing the required parameter 'authorization_group_name' when calling AuthorizationGroupApi.update_msg_vpn_authorization_group" if authorization_group_name.nil?
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling AuthorizationGroupApi.update_msg_vpn_authorization_group" if body.nil?
      # resource path
      local_var_path = "/msgVpns/{msgVpnName}/authorizationGroups/{authorizationGroupName}".sub('{format}','json').sub('{' + 'msgVpnName' + '}', msg_vpn_name.to_s).sub('{' + 'authorizationGroupName' + '}', authorization_group_name.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path,
        ...
        :return_type => 'MsgVpnAuthorizationGroupResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuthorizationGroupApi#update_msg_vpn_authorization_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
