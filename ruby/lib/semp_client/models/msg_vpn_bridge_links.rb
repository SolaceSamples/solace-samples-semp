...
module SempClient
  ...
  class MsgVpnBridgeLinks
    ...
    def self.swagger_types
      {
        :'remote_msg_vpns_uri' => :'String',
        :'remote_subscriptions_uri' => :'String',
        :'tls_trusted_common_names_uri' => :'String',
        :'uri' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'remoteMsgVpnsUri')
        self.remote_msg_vpns_uri = attributes[:'remoteMsgVpnsUri']
      end

      if attributes.has_key?(:'remoteSubscriptionsUri')
        self.remote_subscriptions_uri = attributes[:'remoteSubscriptionsUri']
      end

      if attributes.has_key?(:'tlsTrustedCommonNamesUri')
        self.tls_trusted_common_names_uri = attributes[:'tlsTrustedCommonNamesUri']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          remote_msg_vpns_uri == o.remote_msg_vpns_uri &&
          remote_subscriptions_uri == o.remote_subscriptions_uri &&
          tls_trusted_common_names_uri == o.tls_trusted_common_names_uri &&
          uri == o.uri
    end
    ...
    def hash
      [remote_msg_vpns_uri, remote_subscriptions_uri, tls_trusted_common_names_uri, uri].hash
    end
