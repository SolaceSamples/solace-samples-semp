...
module SempClient
  ...
  class MsgVpnAclProfilePublishException
    ...
    attr_accessor :publish_exception_topic
    ...
    def self.swagger_types
      {
        ...
        :'msg_vpn_name' => :'String',
        :'publish_exception_topic' => :'String',
        :'topic_syntax' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'publishExceptionTopic')
        self.publish_exception_topic = attributes[:'publishExceptionTopic']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          publish_exception_topic == o.publish_exception_topic &&
    ...
    def hash
      [acl_profile_name, msg_vpn_name, publish_exception_topic, topic_syntax].hash
    end
