...
module SempClient
  ...
  class MsgVpnQueueSubscription
    ...
    attr_accessor :subscription_topic
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'subscriptionTopic')
        self.subscription_topic = attributes[:'subscriptionTopic']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          subscription_topic == o.subscription_topic
    end
    ...
    def hash
      [msg_vpn_name, queue_name, subscription_topic].hash
    end
