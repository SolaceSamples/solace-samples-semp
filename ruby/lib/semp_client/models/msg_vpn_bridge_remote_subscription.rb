...
module SempClient
  ...
  class MsgVpnBridgeRemoteSubscription
    ...
    attr_accessor :deliver_always_enabled

    # The name of the Message VPN.
    attr_accessor :msg_vpn_name

    # The topic of the Remote Subscription.
    attr_accessor :remote_subscription_topic
    ...
    def self.swagger_types
      {
        ...
        :'deliver_always_enabled' => :'BOOLEAN',
        :'msg_vpn_name' => :'String',
        :'remote_subscription_topic' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'deliverAlwaysEnabled')
        self.deliver_always_enabled = attributes[:'deliverAlwaysEnabled']
      end
      ...
      if attributes.has_key?(:'remoteSubscriptionTopic')
        self.remote_subscription_topic = attributes[:'remoteSubscriptionTopic']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          deliver_always_enabled == o.deliver_always_enabled &&
          msg_vpn_name == o.msg_vpn_name &&
          remote_subscription_topic == o.remote_subscription_topic
    end
    ...
    def hash
      [bridge_name, bridge_virtual_router, deliver_always_enabled, msg_vpn_name, remote_subscription_topic].hash
    end
