...
module SempClient
  ...
  class MsgVpnBridgeTlsTrustedCommonName
    ...
    attr_accessor :tls_trusted_common_name
    ...
    def self.swagger_types
      {
        ...
        :'msg_vpn_name' => :'String',
        :'tls_trusted_common_name' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'tlsTrustedCommonName')
        self.tls_trusted_common_name = attributes[:'tlsTrustedCommonName']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tls_trusted_common_name == o.tls_trusted_common_name
    end
    ...
    def hash
      [bridge_name, bridge_virtual_router, msg_vpn_name, tls_trusted_common_name].hash
    end
