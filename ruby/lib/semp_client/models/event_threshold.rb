...
module SempClient
  ...
  class EventThreshold
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'clearPercent')
        self.clear_percent = attributes[:'clearPercent']
      end

      if attributes.has_key?(:'clearValue')
        self.clear_value = attributes[:'clearValue']
      end

      if attributes.has_key?(:'setPercent')
        self.set_percent = attributes[:'setPercent']
      end

      if attributes.has_key?(:'setValue')
        self.set_value = attributes[:'setValue']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          clear_percent == o.clear_percent &&
          clear_value == o.clear_value &&
          set_percent == o.set_percent &&
    ...
    def hash
      [clear_percent, clear_value, set_percent, set_value].hash
    end
