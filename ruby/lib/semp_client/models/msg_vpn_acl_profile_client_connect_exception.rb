...
module SempClient
  ...
  class MsgVpnAclProfileClientConnectException
    ...
    def self.swagger_types
      {
        ...
        :'client_connect_exception_address' => :'String',
        :'msg_vpn_name' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'clientConnectExceptionAddress')
        self.client_connect_exception_address = attributes[:'clientConnectExceptionAddress']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          client_connect_exception_address == o.client_connect_exception_address &&
    ...
    def hash
      [acl_profile_name, client_connect_exception_address, msg_vpn_name].hash
    end
