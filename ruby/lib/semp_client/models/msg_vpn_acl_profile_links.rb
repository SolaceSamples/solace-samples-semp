...
module SempClient
  ...
  class MsgVpnAclProfileLinks
    ...
    def self.swagger_types
      {
        :'client_connect_exceptions_uri' => :'String',
        :'publish_exceptions_uri' => :'String',
        :'subscribe_exceptions_uri' => :'String',
        :'uri' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'clientConnectExceptionsUri')
        self.client_connect_exceptions_uri = attributes[:'clientConnectExceptionsUri']
      end

      if attributes.has_key?(:'publishExceptionsUri')
        self.publish_exceptions_uri = attributes[:'publishExceptionsUri']
      end

      if attributes.has_key?(:'subscribeExceptionsUri')
        self.subscribe_exceptions_uri = attributes[:'subscribeExceptionsUri']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          client_connect_exceptions_uri == o.client_connect_exceptions_uri &&
          publish_exceptions_uri == o.publish_exceptions_uri &&
          subscribe_exceptions_uri == o.subscribe_exceptions_uri &&
          uri == o.uri
    end
    ...
    def hash
      [client_connect_exceptions_uri, publish_exceptions_uri, subscribe_exceptions_uri, uri].hash
    end
