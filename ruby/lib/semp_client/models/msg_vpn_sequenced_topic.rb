...
module SempClient
  ...
  class MsgVpnSequencedTopic
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sequencedTopic')
        self.sequenced_topic = attributes[:'sequencedTopic']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sequenced_topic == o.sequenced_topic
    end
    ...
    def hash
      [msg_vpn_name, sequenced_topic].hash
    end
