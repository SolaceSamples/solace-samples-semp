...
module SempClient
  ...
  class MsgVpnAclProfile
    # The name of the ACL Profile.
    attr_accessor :acl_profile_name
    ...
    attr_accessor :client_connect_default_action
    ...
    attr_accessor :publish_topic_default_action
    ...
    attr_accessor :subscribe_topic_default_action
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'aclProfileName')
        self.acl_profile_name = attributes[:'aclProfileName']
      end

      if attributes.has_key?(:'clientConnectDefaultAction')
        self.client_connect_default_action = attributes[:'clientConnectDefaultAction']
      end
      ...
      if attributes.has_key?(:'publishTopicDefaultAction')
        self.publish_topic_default_action = attributes[:'publishTopicDefaultAction']
      end

      if attributes.has_key?(:'subscribeTopicDefaultAction')
        self.subscribe_topic_default_action = attributes[:'subscribeTopicDefaultAction']
      end
    ...
    def valid?
      client_connect_default_action_validator = EnumAttributeValidator.new('String', ["allow", "disallow"])
      return false unless client_connect_default_action_validator.valid?(@client_connect_default_action)
      publish_topic_default_action_validator = EnumAttributeValidator.new('String', ["allow", "disallow"])
      return false unless publish_topic_default_action_validator.valid?(@publish_topic_default_action)
      subscribe_topic_default_action_validator = EnumAttributeValidator.new('String', ["allow", "disallow"])
      return false unless subscribe_topic_default_action_validator.valid?(@subscribe_topic_default_action)
      return true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] client_connect_default_action Object to be assigned
    def client_connect_default_action=(client_connect_default_action)
      validator = EnumAttributeValidator.new('String', ["allow", "disallow"])
      unless validator.valid?(client_connect_default_action)
        fail ArgumentError, "invalid value for 'client_connect_default_action', must be one of #{validator.allowable_values}."
      end
      @client_connect_default_action = client_connect_default_action
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] publish_topic_default_action Object to be assigned
    def publish_topic_default_action=(publish_topic_default_action)
      validator = EnumAttributeValidator.new('String', ["allow", "disallow"])
      unless validator.valid?(publish_topic_default_action)
        fail ArgumentError, "invalid value for 'publish_topic_default_action', must be one of #{validator.allowable_values}."
      end
      @publish_topic_default_action = publish_topic_default_action
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] subscribe_topic_default_action Object to be assigned
    def subscribe_topic_default_action=(subscribe_topic_default_action)
      validator = EnumAttributeValidator.new('String', ["allow", "disallow"])
      unless validator.valid?(subscribe_topic_default_action)
        fail ArgumentError, "invalid value for 'subscribe_topic_default_action', must be one of #{validator.allowable_values}."
      end
      @subscribe_topic_default_action = subscribe_topic_default_action
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          acl_profile_name == o.acl_profile_name &&
          client_connect_default_action == o.client_connect_default_action &&
          msg_vpn_name == o.msg_vpn_name &&
          publish_topic_default_action == o.publish_topic_default_action &&
          subscribe_topic_default_action == o.subscribe_topic_default_action
    end
    ...
    def hash
      [acl_profile_name, client_connect_default_action, msg_vpn_name, publish_topic_default_action, subscribe_topic_default_action].hash
    end
