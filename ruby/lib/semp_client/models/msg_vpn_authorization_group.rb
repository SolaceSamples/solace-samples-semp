...
module SempClient
  ...
  class MsgVpnAuthorizationGroup
    ...
    attr_accessor :authorization_group_name
    ...
    attr_accessor :order_after_authorization_group_name

    # Raise the priority to be greater than this group. The default is not applicable.
    attr_accessor :order_before_authorization_group_name
    ...
    def self.swagger_types
      {
        ...
        :'enabled' => :'BOOLEAN',
        :'msg_vpn_name' => :'String',
        :'order_after_authorization_group_name' => :'String',
        :'order_before_authorization_group_name' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'authorizationGroupName')
        self.authorization_group_name = attributes[:'authorizationGroupName']
      end
      ...
      if attributes.has_key?(:'orderAfterAuthorizationGroupName')
        self.order_after_authorization_group_name = attributes[:'orderAfterAuthorizationGroupName']
      end

      if attributes.has_key?(:'orderBeforeAuthorizationGroupName')
        self.order_before_authorization_group_name = attributes[:'orderBeforeAuthorizationGroupName']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          authorization_group_name == o.authorization_group_name &&
          client_profile_name == o.client_profile_name &&
          enabled == o.enabled &&
          msg_vpn_name == o.msg_vpn_name &&
          order_after_authorization_group_name == o.order_after_authorization_group_name &&
          order_before_authorization_group_name == o.order_before_authorization_group_name
    end
    ...
    def hash
      [acl_profile_name, authorization_group_name, client_profile_name, enabled, msg_vpn_name, order_after_authorization_group_name, order_before_authorization_group_name].hash
    end
