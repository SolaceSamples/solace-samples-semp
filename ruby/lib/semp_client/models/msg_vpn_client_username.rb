...
module SempClient
  ...
  class MsgVpnClientUsername
    ...
    attr_accessor :guaranteed_endpoint_permission_override_enabled
    ...
    attr_accessor :subscription_manager_enabled
    ...
    def self.swagger_types
      {
        ...
        :'enabled' => :'BOOLEAN',
        :'guaranteed_endpoint_permission_override_enabled' => :'BOOLEAN',
        :'msg_vpn_name' => :'String',
        :'password' => :'String',
        :'subscription_manager_enabled' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'guaranteedEndpointPermissionOverrideEnabled')
        self.guaranteed_endpoint_permission_override_enabled = attributes[:'guaranteedEndpointPermissionOverrideEnabled']
      end
      ...
      if attributes.has_key?(:'subscriptionManagerEnabled')
        self.subscription_manager_enabled = attributes[:'subscriptionManagerEnabled']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enabled == o.enabled &&
          guaranteed_endpoint_permission_override_enabled == o.guaranteed_endpoint_permission_override_enabled &&
          msg_vpn_name == o.msg_vpn_name &&
          password == o.password &&
          subscription_manager_enabled == o.subscription_manager_enabled
    end
    ...
    def hash
      [acl_profile_name, client_profile_name, client_username, enabled, guaranteed_endpoint_permission_override_enabled, msg_vpn_name, password, subscription_manager_enabled].hash
    end
