...
module SempClient
  ...
  class MsgVpnBridge
    ...
    attr_accessor :bridge_virtual_router
    ...
    attr_accessor :remote_authentication_basic_client_username
    ...
    attr_accessor :remote_authentication_basic_password
    ...
    attr_accessor :remote_authentication_scheme
    ...
    attr_accessor :remote_deliver_to_one_priority
    ...
    def self.swagger_types
      {
        ...
        :'max_ttl' => :'Integer',
        :'msg_vpn_name' => :'String',
        :'remote_authentication_basic_client_username' => :'String',
        :'remote_authentication_basic_password' => :'String',
        :'remote_authentication_scheme' => :'String',
        :'remote_connection_retry_count' => :'Integer',
        :'remote_connection_retry_delay' => :'Integer',
        :'remote_deliver_to_one_priority' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bridgeName')
        self.bridge_name = attributes[:'bridgeName']
      end

      if attributes.has_key?(:'bridgeVirtualRouter')
        self.bridge_virtual_router = attributes[:'bridgeVirtualRouter']
      end
      ...
      if attributes.has_key?(:'remoteAuthenticationBasicClientUsername')
        self.remote_authentication_basic_client_username = attributes[:'remoteAuthenticationBasicClientUsername']
      end

      if attributes.has_key?(:'remoteAuthenticationBasicPassword')
        self.remote_authentication_basic_password = attributes[:'remoteAuthenticationBasicPassword']
      end

      if attributes.has_key?(:'remoteAuthenticationScheme')
        self.remote_authentication_scheme = attributes[:'remoteAuthenticationScheme']
      end

      if attributes.has_key?(:'remoteConnectionRetryCount')
        self.remote_connection_retry_count = attributes[:'remoteConnectionRetryCount']
      end

      if attributes.has_key?(:'remoteConnectionRetryDelay')
        self.remote_connection_retry_delay = attributes[:'remoteConnectionRetryDelay']
      end

      if attributes.has_key?(:'remoteDeliverToOnePriority')
        self.remote_deliver_to_one_priority = attributes[:'remoteDeliverToOnePriority']
      end
    ...
    def valid?
      bridge_virtual_router_validator = EnumAttributeValidator.new('String', ["primary", "backup"])
      return false unless bridge_virtual_router_validator.valid?(@bridge_virtual_router)
      remote_authentication_scheme_validator = EnumAttributeValidator.new('String', ["basic", "client-certificate"])
      return false unless remote_authentication_scheme_validator.valid?(@remote_authentication_scheme)
      remote_deliver_to_one_priority_validator = EnumAttributeValidator.new('String', ["p1", "p2", "p3", "p4", "da"])
      return false unless remote_deliver_to_one_priority_validator.valid?(@remote_deliver_to_one_priority)
      return true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] bridge_virtual_router Object to be assigned
    def bridge_virtual_router=(bridge_virtual_router)
      validator = EnumAttributeValidator.new('String', ["primary", "backup"])
      unless validator.valid?(bridge_virtual_router)
        fail ArgumentError, "invalid value for 'bridge_virtual_router', must be one of #{validator.allowable_values}."
      end
      @bridge_virtual_router = bridge_virtual_router
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] remote_authentication_scheme Object to be assigned
    def remote_authentication_scheme=(remote_authentication_scheme)
      validator = EnumAttributeValidator.new('String', ["basic", "client-certificate"])
      unless validator.valid?(remote_authentication_scheme)
        fail ArgumentError, "invalid value for 'remote_authentication_scheme', must be one of #{validator.allowable_values}."
      end
      @remote_authentication_scheme = remote_authentication_scheme
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] remote_deliver_to_one_priority Object to be assigned
    def remote_deliver_to_one_priority=(remote_deliver_to_one_priority)
      validator = EnumAttributeValidator.new('String', ["p1", "p2", "p3", "p4", "da"])
      unless validator.valid?(remote_deliver_to_one_priority)
        fail ArgumentError, "invalid value for 'remote_deliver_to_one_priority', must be one of #{validator.allowable_values}."
      end
      @remote_deliver_to_one_priority = remote_deliver_to_one_priority
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bridge_virtual_router == o.bridge_virtual_router &&
          enabled == o.enabled &&
          max_ttl == o.max_ttl &&
          msg_vpn_name == o.msg_vpn_name &&
          remote_authentication_basic_client_username == o.remote_authentication_basic_client_username &&
          remote_authentication_basic_password == o.remote_authentication_basic_password &&
          remote_authentication_scheme == o.remote_authentication_scheme &&
          remote_connection_retry_count == o.remote_connection_retry_count &&
          remote_connection_retry_delay == o.remote_connection_retry_delay &&
          remote_deliver_to_one_priority == o.remote_deliver_to_one_priority &&
    ...
    def hash
      [bridge_name, bridge_virtual_router, enabled, max_ttl, msg_vpn_name, remote_authentication_basic_client_username, remote_authentication_basic_password, remote_authentication_scheme, remote_connection_retry_count, remote_connection_retry_delay, remote_deliver_to_one_priority, tls_cipher_suite_list].hash
    end
