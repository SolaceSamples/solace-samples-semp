...
module SempClient
  ...
  class MsgVpnRestDeliveryPointLinks
    ...
    def self.swagger_types
      {
        :'queue_bindings_uri' => :'String',
        :'rest_consumers_uri' => :'String',
        :'uri' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'queueBindingsUri')
        self.queue_bindings_uri = attributes[:'queueBindingsUri']
      end

      if attributes.has_key?(:'restConsumersUri')
        self.rest_consumers_uri = attributes[:'restConsumersUri']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          queue_bindings_uri == o.queue_bindings_uri &&
          rest_consumers_uri == o.rest_consumers_uri &&
          uri == o.uri
    end
    ...
    def hash
      [queue_bindings_uri, rest_consumers_uri, uri].hash
    end
