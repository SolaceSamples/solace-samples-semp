...
module SempClient
  ...
  class MsgVpnRestDeliveryPointQueueBinding
    ...
    attr_accessor :post_request_target

    # The name of a queue within this Message VPN.
    attr_accessor :queue_binding_name
    ...
    def self.swagger_types
      {
        :'msg_vpn_name' => :'String',
        :'post_request_target' => :'String',
        :'queue_binding_name' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'postRequestTarget')
        self.post_request_target = attributes[:'postRequestTarget']
      end

      if attributes.has_key?(:'queueBindingName')
        self.queue_binding_name = attributes[:'queueBindingName']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          post_request_target == o.post_request_target &&
          queue_binding_name == o.queue_binding_name &&
    ...
    def hash
      [msg_vpn_name, post_request_target, queue_binding_name, rest_delivery_point_name].hash
    end
