...
module SempClient
  ...
  class MsgVpnAclProfileSubscribeException
    ...
    attr_accessor :subscribe_exception_topic
    ...
    def self.swagger_types
      {
        ...
        :'msg_vpn_name' => :'String',
        :'subscribe_exception_topic' => :'String',
        :'topic_syntax' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'subscribeExceptionTopic')
        self.subscribe_exception_topic = attributes[:'subscribeExceptionTopic']
      end

      if attributes.has_key?(:'topicSyntax')
        self.topic_syntax = attributes[:'topicSyntax']
      end
    ...
    def valid?
      topic_syntax_validator = EnumAttributeValidator.new('String', ["smf", "mqtt"])
      return false unless topic_syntax_validator.valid?(@topic_syntax)
      return true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] topic_syntax Object to be assigned
    def topic_syntax=(topic_syntax)
      validator = EnumAttributeValidator.new('String', ["smf", "mqtt"])
      unless validator.valid?(topic_syntax)
        fail ArgumentError, "invalid value for 'topic_syntax', must be one of #{validator.allowable_values}."
      end
      @topic_syntax = topic_syntax
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          subscribe_exception_topic == o.subscribe_exception_topic &&
          topic_syntax == o.topic_syntax
    end
    ...
    def hash
      [acl_profile_name, msg_vpn_name, subscribe_exception_topic, topic_syntax].hash
    end
