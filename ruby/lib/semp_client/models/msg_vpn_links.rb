...
module SempClient
  ...
  class MsgVpnLinks
    ...
    def self.swagger_types
      {
        :'acl_profiles_uri' => :'String',
        :'authorization_groups_uri' => :'String',
        :'bridges_uri' => :'String',
        :'client_profiles_uri' => :'String',
        :'client_usernames_uri' => :'String',
        :'queues_uri' => :'String',
        :'rest_delivery_points_uri' => :'String',
        :'sequenced_topics_uri' => :'String',
        :'uri' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'aclProfilesUri')
        self.acl_profiles_uri = attributes[:'aclProfilesUri']
      end

      if attributes.has_key?(:'authorizationGroupsUri')
        self.authorization_groups_uri = attributes[:'authorizationGroupsUri']
      end

      if attributes.has_key?(:'bridgesUri')
        self.bridges_uri = attributes[:'bridgesUri']
      end

      if attributes.has_key?(:'clientProfilesUri')
        self.client_profiles_uri = attributes[:'clientProfilesUri']
      end

      if attributes.has_key?(:'clientUsernamesUri')
        self.client_usernames_uri = attributes[:'clientUsernamesUri']
      end

      if attributes.has_key?(:'queuesUri')
        self.queues_uri = attributes[:'queuesUri']
      end

      if attributes.has_key?(:'restDeliveryPointsUri')
        self.rest_delivery_points_uri = attributes[:'restDeliveryPointsUri']
      end

      if attributes.has_key?(:'sequencedTopicsUri')
        self.sequenced_topics_uri = attributes[:'sequencedTopicsUri']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          acl_profiles_uri == o.acl_profiles_uri &&
          authorization_groups_uri == o.authorization_groups_uri &&
          bridges_uri == o.bridges_uri &&
          client_profiles_uri == o.client_profiles_uri &&
          client_usernames_uri == o.client_usernames_uri &&
          queues_uri == o.queues_uri &&
          rest_delivery_points_uri == o.rest_delivery_points_uri &&
          sequenced_topics_uri == o.sequenced_topics_uri &&
          uri == o.uri
    end
    ...
    def hash
      [acl_profiles_uri, authorization_groups_uri, bridges_uri, client_profiles_uri, client_usernames_uri, queues_uri, rest_delivery_points_uri, sequenced_topics_uri, uri].hash
    end
