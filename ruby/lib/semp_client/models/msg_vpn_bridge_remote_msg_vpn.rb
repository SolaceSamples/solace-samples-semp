...
module SempClient
  ...
  class MsgVpnBridgeRemoteMsgVpn
    ...
    attr_accessor :compressed_data_enabled
    ...
    attr_accessor :egress_flow_window_size
    ...
    attr_accessor :remote_msg_vpn_interface
    ...
    attr_accessor :remote_msg_vpn_location

    # The name of the Remote Message VPN.
    attr_accessor :remote_msg_vpn_name
    ...
    attr_accessor :unidirectional_client_profile
    ...
    def self.swagger_types
      {
        ...
        :'compressed_data_enabled' => :'BOOLEAN',
        :'connect_order' => :'Integer',
        :'egress_flow_window_size' => :'Integer',
        :'enabled' => :'BOOLEAN',
        :'msg_vpn_name' => :'String',
        :'password' => :'String',
        :'queue_binding' => :'String',
        :'remote_msg_vpn_interface' => :'String',
        :'remote_msg_vpn_location' => :'String',
        :'remote_msg_vpn_name' => :'String',
        :'tls_enabled' => :'BOOLEAN',
        :'unidirectional_client_profile' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'clientUsername')
        self.client_username = attributes[:'clientUsername']
      end

      if attributes.has_key?(:'compressedDataEnabled')
        self.compressed_data_enabled = attributes[:'compressedDataEnabled']
      end

      if attributes.has_key?(:'connectOrder')
        self.connect_order = attributes[:'connectOrder']
      end

      if attributes.has_key?(:'egressFlowWindowSize')
        self.egress_flow_window_size = attributes[:'egressFlowWindowSize']
      end
      ...
      if attributes.has_key?(:'queueBinding')
        self.queue_binding = attributes[:'queueBinding']
      end

      if attributes.has_key?(:'remoteMsgVpnInterface')
        self.remote_msg_vpn_interface = attributes[:'remoteMsgVpnInterface']
      end

      if attributes.has_key?(:'remoteMsgVpnLocation')
        self.remote_msg_vpn_location = attributes[:'remoteMsgVpnLocation']
      end

      if attributes.has_key?(:'remoteMsgVpnName')
        self.remote_msg_vpn_name = attributes[:'remoteMsgVpnName']
      end
      ...
      if attributes.has_key?(:'unidirectionalClientProfile')
        self.unidirectional_client_profile = attributes[:'unidirectionalClientProfile']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          compressed_data_enabled == o.compressed_data_enabled &&
          connect_order == o.connect_order &&
          egress_flow_window_size == o.egress_flow_window_size &&
          enabled == o.enabled &&
          msg_vpn_name == o.msg_vpn_name &&
          password == o.password &&
          queue_binding == o.queue_binding &&
          remote_msg_vpn_interface == o.remote_msg_vpn_interface &&
          remote_msg_vpn_location == o.remote_msg_vpn_location &&
          remote_msg_vpn_name == o.remote_msg_vpn_name &&
          tls_enabled == o.tls_enabled &&
          unidirectional_client_profile == o.unidirectional_client_profile
    end
    ...
    def hash
      [bridge_name, bridge_virtual_router, client_username, compressed_data_enabled, connect_order, egress_flow_window_size, enabled, msg_vpn_name, password, queue_binding, remote_msg_vpn_interface, remote_msg_vpn_location, remote_msg_vpn_name, tls_enabled, unidirectional_client_profile].hash
    end
