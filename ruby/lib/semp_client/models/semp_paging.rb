...
module SempClient
  ...
  class SempPaging
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cursorQuery')
        self.cursor_query = attributes[:'cursorQuery']
      end

      if attributes.has_key?(:'nextPageUri')
        self.next_page_uri = attributes[:'nextPageUri']
      end
    ...
    def valid?
      return false if @cursor_query.nil?
      return false if @next_page_uri.nil?
      return true
    end
    ...
    def hash
      [cursor_query, next_page_uri].hash
    end
