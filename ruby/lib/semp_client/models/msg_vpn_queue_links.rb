...
module SempClient
  ...
  class MsgVpnQueueLinks
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'subscriptionsUri')
        self.subscriptions_uri = attributes[:'subscriptionsUri']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          subscriptions_uri == o.subscriptions_uri &&
          uri == o.uri
    end
