---
layout: tutorials
title: Message VPN creation with Queue – Java 
...
* Demonstrate how to integrate the management of Solace message routers into Java-based DevOps tools using the SEMP Java Client Library
...
To accomplish this, we will create a set of tasks as building blocks that match the SEMP object model of the Solace message router and use a simple framework to demonstrate the integration and orchestration of these tasks to achieve above objectives. We will use the SEMP Java Client Library to implement these tasks, extending the concepts introduced in the [Basic Operations - Java Client Library]({{ site.baseurl }}/java-client) tutorial.
