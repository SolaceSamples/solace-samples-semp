...
public class MsgVpnRestDeliveryPoint   {
  ...
  public MsgVpnRestDeliveryPoint clientProfileName(String clientProfileName) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The client-profile of this REST Delivery Point. The client-profile must exist in the local Message VPN. Its TCP parameters are used for all REST Consumers in this RDP. Additionally, the RDP client uses the associated queue properties, such as the queue max-depth and min-msg-burst. The client-profile is used inside the auto-generated client-username for this RDP. The default value is `\"default\"`.")
  ...
  public MsgVpnRestDeliveryPoint enabled(Boolean enabled) {
   ...
   * @return enabled
  **/
  @ApiModelProperty(example = "null", value = "Enable or disable the REST Delivery Point. When disabled, no connections are initiated or messages delivered to any of the contained REST Consumers. The default value is `false`.")
  ...
  public MsgVpnRestDeliveryPoint msgVpnName(String msgVpnName) {
  ...
  **/
  ...
  public MsgVpnRestDeliveryPoint restDeliveryPointName(String restDeliveryPointName) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnRestDeliveryPoint msgVpnRestDeliveryPoint = (MsgVpnRestDeliveryPoint) o;
    return Objects.equals(this.clientProfileName, msgVpnRestDeliveryPoint.clientProfileName) &&
        Objects.equals(this.enabled, msgVpnRestDeliveryPoint.enabled) &&
        Objects.equals(this.msgVpnName, msgVpnRestDeliveryPoint.msgVpnName) &&
        Objects.equals(this.restDeliveryPointName, msgVpnRestDeliveryPoint.restDeliveryPointName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientProfileName, enabled, msgVpnName, restDeliveryPointName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MsgVpnRestDeliveryPoint {\n");
