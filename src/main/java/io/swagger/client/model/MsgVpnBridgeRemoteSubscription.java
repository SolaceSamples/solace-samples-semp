...
public class MsgVpnBridgeRemoteSubscription   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Flag the topic as deliver-always instead of with the configured deliver-to-one remote-priority value for the bridge. A given topic may be deliver-to-one or deliver-always but not both.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The topic of the Remote Subscription.")
