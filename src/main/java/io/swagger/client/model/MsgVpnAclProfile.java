...
public class MsgVpnAclProfile   {
  ...
  /**
   * The default action to take when a client connects. The default value is `\"disallow\"`. The allowed values and their meaning are:      \"allow\" - Allow client connection unless an exception is found for it.     \"disallow\" - Disallow client connection unless an exception is found for it. 
   */
  public enum ClientConnectDefaultActionEnum {
    ...
    ClientConnectDefaultActionEnum(String value) {
      this.value = value;
    }
  ...
  @SerializedName("clientConnectDefaultAction")
  private ClientConnectDefaultActionEnum clientConnectDefaultAction = null;

  @SerializedName("msgVpnName")
  private String msgVpnName = null;

  /**
   * The default action to take when a client publishes to a topic. The default value is `\"disallow\"`. The allowed values and their meaning are:      \"allow\" - Allow topic unless an exception is found for it.     \"disallow\" - Disallow topic unless an exception is found for it. 
   */
  public enum PublishTopicDefaultActionEnum {
    @SerializedName("allow")
    ALLOW("allow"),
    ...
    PublishTopicDefaultActionEnum(String value) {
      this.value = value;
    }
  ...
  @SerializedName("publishTopicDefaultAction")
  private PublishTopicDefaultActionEnum publishTopicDefaultAction = null;

  /**
   * The default action to take when a client subscribes to a topic. The default value is `\"disallow\"`. The allowed values and their meaning are:      \"allow\" - Allow topic unless an exception is found for it.     \"disallow\" - Disallow topic unless an exception is found for it. 
   */
  public enum SubscribeTopicDefaultActionEnum {
    @SerializedName("allow")
    ALLOW("allow"),
    ...
    SubscribeTopicDefaultActionEnum(String value) {
      this.value = value;
    }
  ...
  @SerializedName("subscribeTopicDefaultAction")
  private SubscribeTopicDefaultActionEnum subscribeTopicDefaultAction = null;

  public MsgVpnAclProfile aclProfileName(String aclProfileName) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The name of the ACL Profile.")
  ...
  public MsgVpnAclProfile clientConnectDefaultAction(ClientConnectDefaultActionEnum clientConnectDefaultAction) {
    this.clientConnectDefaultAction = clientConnectDefaultAction;
    return this;
  }

   /**
   * The default action to take when a client connects. The default value is `\"disallow\"`. The allowed values and their meaning are:      \"allow\" - Allow client connection unless an exception is found for it.     \"disallow\" - Disallow client connection unless an exception is found for it. 
   * @return clientConnectDefaultAction
  **/
  @ApiModelProperty(example = "null", value = "The default action to take when a client connects. The default value is `\"disallow\"`. The allowed values and their meaning are:      \"allow\" - Allow client connection unless an exception is found for it.     \"disallow\" - Disallow client connection unless an exception is found for it. ")
  public ClientConnectDefaultActionEnum getClientConnectDefaultAction() {
    return clientConnectDefaultAction;
  }

  public void setClientConnectDefaultAction(ClientConnectDefaultActionEnum clientConnectDefaultAction) {
    this.clientConnectDefaultAction = clientConnectDefaultAction;
  }

  public MsgVpnAclProfile msgVpnName(String msgVpnName) {
  ...
  **/
  ...
  public MsgVpnAclProfile publishTopicDefaultAction(PublishTopicDefaultActionEnum publishTopicDefaultAction) {
   ...
   /**
   * The default action to take when a client publishes to a topic. The default value is `\"disallow\"`. The allowed values and their meaning are:      \"allow\" - Allow topic unless an exception is found for it.     \"disallow\" - Disallow topic unless an exception is found for it. 
   * @return publishTopicDefaultAction
  **/
  @ApiModelProperty(example = "null", value = "The default action to take when a client publishes to a topic. The default value is `\"disallow\"`. The allowed values and their meaning are:      \"allow\" - Allow topic unless an exception is found for it.     \"disallow\" - Disallow topic unless an exception is found for it. ")
  public PublishTopicDefaultActionEnum getPublishTopicDefaultAction() {
    return publishTopicDefaultAction;
  }

  public void setPublishTopicDefaultAction(PublishTopicDefaultActionEnum publishTopicDefaultAction) {
    this.publishTopicDefaultAction = publishTopicDefaultAction;
  }

  public MsgVpnAclProfile subscribeTopicDefaultAction(SubscribeTopicDefaultActionEnum subscribeTopicDefaultAction) {
    this.subscribeTopicDefaultAction = subscribeTopicDefaultAction;
    return this;
  }

   /**
   * The default action to take when a client subscribes to a topic. The default value is `\"disallow\"`. The allowed values and their meaning are:      \"allow\" - Allow topic unless an exception is found for it.     \"disallow\" - Disallow topic unless an exception is found for it. 
   * @return subscribeTopicDefaultAction
  **/
  @ApiModelProperty(example = "null", value = "The default action to take when a client subscribes to a topic. The default value is `\"disallow\"`. The allowed values and their meaning are:      \"allow\" - Allow topic unless an exception is found for it.     \"disallow\" - Disallow topic unless an exception is found for it. ")
  public SubscribeTopicDefaultActionEnum getSubscribeTopicDefaultAction() {
    return subscribeTopicDefaultAction;
  }

  public void setSubscribeTopicDefaultAction(SubscribeTopicDefaultActionEnum subscribeTopicDefaultAction) {
    this.subscribeTopicDefaultAction = subscribeTopicDefaultAction;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnAclProfile msgVpnAclProfile = (MsgVpnAclProfile) o;
    return Objects.equals(this.aclProfileName, msgVpnAclProfile.aclProfileName) &&
        Objects.equals(this.clientConnectDefaultAction, msgVpnAclProfile.clientConnectDefaultAction) &&
        Objects.equals(this.msgVpnName, msgVpnAclProfile.msgVpnName) &&
        Objects.equals(this.publishTopicDefaultAction, msgVpnAclProfile.publishTopicDefaultAction) &&
        Objects.equals(this.subscribeTopicDefaultAction, msgVpnAclProfile.subscribeTopicDefaultAction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aclProfileName, clientConnectDefaultAction, msgVpnName, publishTopicDefaultAction, subscribeTopicDefaultAction);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MsgVpnAclProfile {\n");
