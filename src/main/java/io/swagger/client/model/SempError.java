...
public class SempError   {
  ...
  public SempError code(Integer code) {
    this.code = code;
    return this;
  }
   ...
   * @return code
  **/
  @ApiModelProperty(example = "null", required = true, value = "The error code which uniquely identifies the error that has occurred.")
  ...
  public SempError description(String description) {
   ...
   * @return description
  **/
  @ApiModelProperty(example = "null", required = true, value = "The verbose description of the problem.")
  ...
  public SempError status(String status) {
    this.status = status;
    return this;
  }
   ...
   * @return status
  **/
  @ApiModelProperty(example = "null", required = true, value = "The terse status string associated with `code`.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SempError sempError = (SempError) o;
    return Objects.equals(this.code, sempError.code) &&
        Objects.equals(this.description, sempError.description) &&
        Objects.equals(this.status, sempError.status);
  }
