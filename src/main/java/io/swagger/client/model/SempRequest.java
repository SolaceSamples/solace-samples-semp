...
public class SempRequest   {
  ...
  public SempRequest method(String method) {
    this.method = method;
    return this;
  }
   ...
   * @return method
  **/
  @ApiModelProperty(example = "null", required = true, value = "The HTTP method of the request which resulted in this response.")
  ...
  public SempRequest uri(String uri) {
    this.uri = uri;
    return this;
  }
   ...
   * @return uri
  **/
  @ApiModelProperty(example = "null", required = true, value = "The URI of the request which resulted in this response.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SempRequest sempRequest = (SempRequest) o;
    return Objects.equals(this.method, sempRequest.method) &&
        Objects.equals(this.uri, sempRequest.uri);
  }
