...
public class MsgVpnMqttSessionSubscription {
  @JsonProperty("mqttSessionClientId")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The Client ID of the MQTT Session, which corresponds to the ClientId provided in the MQTT CONNECT packet.")
  ...
  public MsgVpnMqttSessionSubscription mqttSessionVirtualRouter(MqttSessionVirtualRouterEnum mqttSessionVirtualRouter) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The virtual router of the MQTT Session. The allowed values and their meaning are:  <pre> \"primary\" - The MQTT Session belongs to the primary virtual router. \"backup\" - The MQTT Session belongs to the backup virtual router. </pre> ")
  ...
  public MsgVpnMqttSessionSubscription msgVpnName(String msgVpnName) {
  ...
  **/
  ...
  public MsgVpnMqttSessionSubscription subscriptionQos(Long subscriptionQos) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The quality of service (QoS) for the subscription as either 0 (deliver at most once) or 1 (deliver at least once). QoS 2 is not supported, but QoS 2 messages attracted by QoS 0 or QoS 1 subscriptions are accepted and delivered accordingly. The default value is `0`.")
  public Long getSubscriptionQos() {
    return subscriptionQos;
  }

  public void setSubscriptionQos(Long subscriptionQos) {
    this.subscriptionQos = subscriptionQos;
  }

  public MsgVpnMqttSessionSubscription subscriptionTopic(String subscriptionTopic) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The MQTT subscription topic.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnMqttSessionSubscription msgVpnMqttSessionSubscription = (MsgVpnMqttSessionSubscription) o;
    return Objects.equals(this.mqttSessionClientId, msgVpnMqttSessionSubscription.mqttSessionClientId) &&
        Objects.equals(this.mqttSessionVirtualRouter, msgVpnMqttSessionSubscription.mqttSessionVirtualRouter) &&
        Objects.equals(this.msgVpnName, msgVpnMqttSessionSubscription.msgVpnName) &&
        Objects.equals(this.subscriptionQos, msgVpnMqttSessionSubscription.subscriptionQos) &&
        Objects.equals(this.subscriptionTopic, msgVpnMqttSessionSubscription.subscriptionTopic);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mqttSessionClientId, mqttSessionVirtualRouter, msgVpnName, subscriptionQos, subscriptionTopic);
  }
  ...
  public String toString() {
    ...
    sb.append("class MsgVpnMqttSessionSubscription {\n");
