...
public class MsgVpnDistributedCacheClusterInstance {
  ...
  @JsonProperty("stopOnLostMsgEnabled")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Enable or disable auto-start for the Cache Instance. When enabled, the Cache Instance will automatically attempt to transition from the Stopped operational state to Up whenever it restarts or reconnects to the message broker. The default value is `false`.")
  ...
  **/
   ...
   * @return enabled
  **/
  @ApiModelProperty(example = "null", value = "Enable or disable the Cache Instance. The default value is `false`.")
   ...
   * @return instanceName
  **/
  @ApiModelProperty(example = "null", value = "The name of the Cache Instance.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Enable or disable stop-on-lost-message for the Cache Instance. When enabled, the Cache Instance will transition to the stopped operational state upon losing a message. When stopped, it cannot accept or respond to cache requests, but continues to cache messages. The default value is `true`.")
  public Boolean getStopOnLostMsgEnabled() {
    return stopOnLostMsgEnabled;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(autoStartEnabled, cacheName, clusterName, enabled, instanceName, msgVpnName, stopOnLostMsgEnabled);
  }
