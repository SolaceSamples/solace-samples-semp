...
public class MsgVpnBridgeRemoteSubscription {
  ...
  @JsonProperty("deliverAlwaysEnabled")
  private Boolean deliverAlwaysEnabled = null;

  @JsonProperty("msgVpnName")
  private String msgVpnName = null;

  @JsonProperty("remoteSubscriptionTopic")
  private String remoteSubscriptionTopic = null;

  public MsgVpnBridgeRemoteSubscription bridgeName(String bridgeName) {
  ...
  **/
  ...
  public MsgVpnBridgeRemoteSubscription bridgeVirtualRouter(BridgeVirtualRouterEnum bridgeVirtualRouter) {
  ...
  **/
  ...
  public MsgVpnBridgeRemoteSubscription deliverAlwaysEnabled(Boolean deliverAlwaysEnabled) {
    this.deliverAlwaysEnabled = deliverAlwaysEnabled;
    return this;
  }
   ...
   * @return deliverAlwaysEnabled
  **/
  @ApiModelProperty(example = "null", value = "Enable deliver-always for the Bridge remote subscription topic instead of a deliver-to-one remote priority. A given topic for the Bridge may be deliver-to-one or deliver-always but not both.")
  public Boolean getDeliverAlwaysEnabled() {
    return deliverAlwaysEnabled;
  }

  public void setDeliverAlwaysEnabled(Boolean deliverAlwaysEnabled) {
    this.deliverAlwaysEnabled = deliverAlwaysEnabled;
  }
  ...
  **/
  ...
  public MsgVpnBridgeRemoteSubscription remoteSubscriptionTopic(String remoteSubscriptionTopic) {
    this.remoteSubscriptionTopic = remoteSubscriptionTopic;
    return this;
  }

   /**
   * The topic of the Bridge remote subscription.
   * @return remoteSubscriptionTopic
  **/
  @ApiModelProperty(example = "null", value = "The topic of the Bridge remote subscription.")
  public String getRemoteSubscriptionTopic() {
    return remoteSubscriptionTopic;
  }

  public void setRemoteSubscriptionTopic(String remoteSubscriptionTopic) {
    this.remoteSubscriptionTopic = remoteSubscriptionTopic;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnBridgeRemoteSubscription msgVpnBridgeRemoteSubscription = (MsgVpnBridgeRemoteSubscription) o;
    return Objects.equals(this.bridgeName, msgVpnBridgeRemoteSubscription.bridgeName) &&
        Objects.equals(this.bridgeVirtualRouter, msgVpnBridgeRemoteSubscription.bridgeVirtualRouter) &&
        Objects.equals(this.deliverAlwaysEnabled, msgVpnBridgeRemoteSubscription.deliverAlwaysEnabled) &&
        Objects.equals(this.msgVpnName, msgVpnBridgeRemoteSubscription.msgVpnName) &&
        Objects.equals(this.remoteSubscriptionTopic, msgVpnBridgeRemoteSubscription.remoteSubscriptionTopic);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bridgeName, bridgeVirtualRouter, deliverAlwaysEnabled, msgVpnName, remoteSubscriptionTopic);
  }
  ...
  public String toString() {
    ...
    sb.append("class MsgVpnBridgeRemoteSubscription {\n");
