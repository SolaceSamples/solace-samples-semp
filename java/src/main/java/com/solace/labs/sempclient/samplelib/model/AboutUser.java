...
public class AboutUser {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The global access level of the User. The allowed values and their meaning are:  <pre> \"admin\" - Full administrative access. \"none\" - No access. \"read-only\" - Read only access. \"read-write\" - Read and write access. </pre> ")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(globalAccessLevel);
  }
