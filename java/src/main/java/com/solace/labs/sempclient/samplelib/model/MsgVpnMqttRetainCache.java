...
public class MsgVpnMqttRetainCache {
   ...
   * @return cacheName
  **/
  @ApiModelProperty(example = "null", value = "The name of the MQTT Retain Cache.")
   ...
   * @return enabled
  **/
  @ApiModelProperty(example = "null", value = "Enable or disable this MQTT Retain Cache. When the cache is disabled, neither retain messages nor retain requests will be delivered by the cache. However, live retain messages will continue to be delivered to currently connected MQTT clients. The default value is `false`.")
   ...
   * @return msgLifetime
  **/
  @ApiModelProperty(example = "null", value = "The message lifetime, in seconds. If a message remains cached for the duration of its lifetime, the cache will remove the message. A lifetime of 0 results in the message being retained indefinitely. The default value is `0`.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.cacheName, msgVpnMqttRetainCache.cacheName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cacheName, enabled, msgLifetime, msgVpnName);
  }
