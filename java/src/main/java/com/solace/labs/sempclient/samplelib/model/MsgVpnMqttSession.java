...
public class MsgVpnMqttSession {
   ...
   * @return enabled
  **/
  @ApiModelProperty(example = "null", value = "Enable or disable the MQTT Session. When disabled, the client is disconnected, new messages matching QoS 0 subscriptions are discarded, and new messages matching QoS 1 subscriptions are stored for future delivery. The default value is `false`.")
  ...
  **/
   ...
   * @return owner
  **/
  @ApiModelProperty(example = "null", value = "The owner of the MQTT Session. For externally-created sessions this defaults to the Client Username of the connecting client. For management-created sessions this defaults to empty. Before configuring, the MQTT Session must be disabled. The default value is `\"\"`.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(enabled, mqttSessionClientId, mqttSessionVirtualRouter, msgVpnName, owner);
  }
