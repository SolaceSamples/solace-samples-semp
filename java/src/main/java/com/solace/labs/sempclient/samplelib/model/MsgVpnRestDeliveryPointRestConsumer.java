...
public class MsgVpnRestDeliveryPointRestConsumer {
  ...
  @JsonProperty("authenticationHttpBasicPassword")
  private String authenticationHttpBasicPassword = null;

  @JsonProperty("authenticationHttpBasicUsername")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The PEM formatted content for the client certificate that the REST Consumer will present to the REST host. It must consist of a private key and between one and three certificates comprising the certificate trust chain. Changing this attribute requires an HTTPS connection. The default value is `\"\"`. Available since 2.9.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The password for the username. The default value is `\"\"`.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The username that the REST Consumer will use to login to the REST host. Normally a username is only configured when basic authentication is selected for the REST Consumer. The default value is `\"\"`.")
  ...
  **/
   ...
   * @return enabled
  **/
  @ApiModelProperty(example = "null", value = "Enable or disable the REST Consumer. When disabled, no connections are initiated or messages delivered to this particular REST Consumer. The default value is `false`.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The interface that will be used for all outgoing connections associated with the REST Consumer. When unspecified, an interface is automatically chosen. The default value is `\"\"`.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The maximum amount of time (in seconds) to wait for an HTTP POST response from the REST Consumer. Once this time is exceeded, the TCP connection is reset. The default value is `30`.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The number of concurrent TCP connections open to the REST Consumer. The default value is `3`.")
   ...
   * @return remoteHost
  **/
  @ApiModelProperty(example = "null", value = "The IP address or DNS name to which the broker is to connect to deliver messages for the REST Consumer. A host value must be configured for the REST Consumer to be operationally up. The default value is `\"\"`.")
   ...
   * @return remotePort
  **/
  @ApiModelProperty(example = "null", value = "The port associated with the host of the REST Consumer. The default value is `8080`.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The name of the REST Consumer.")
  ...
  **/
   ...
   * @return retryDelay
  **/
  @ApiModelProperty(example = "null", value = "The number of seconds that must pass before retrying the remote REST Consumer connection. The default value is `3`.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The colon-separated list of cipher-suites the REST Consumer uses in its encrypted connection. All supported suites are included by default, from most-secure to least-secure. The REST Consumer should choose the first suite from this list that it supports. The default value is `\"default\"`.")
   ...
   * @return tlsEnabled
  **/
  @ApiModelProperty(example = "null", value = "Indicates whether TLS for the REST Consumer is enabled. The default value is `false`.")
