...
public class MsgVpnClientUsername {
  ...
  @JsonProperty("guaranteedEndpointPermissionOverrideEnabled")
  ...
  @JsonProperty("subscriptionManagerEnabled")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The ACL Profile of the Client Username. The default value is `\"default\"`.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The Client Profile of the Client Username. The default value is `\"default\"`.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The value of the Client Username.")
   ...
   * @return enabled
  **/
  @ApiModelProperty(example = "null", value = "Enables or disables the Client Username. When disabled, all clients currently connected as the Client Username are disconnected. The default value is `false`.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Enables or disables guaranteed endpoint permission override for the Client Username. When enabled all guaranteed endpoints may be accessed, modified or deleted with the same permission as the owner. The default value is `false`.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Enables or disables the subscription management capability of the Client Username. This is the ability to manage subscriptions on behalf of other Client Usernames. The default value is `false`.")
