...
public class DmrClusterLinkRemoteAddress {
  ...
  public DmrClusterLinkRemoteAddress dmrClusterName(String dmrClusterName) {
  ...
  **/
  ...
  public DmrClusterLinkRemoteAddress remoteAddress(String remoteAddress) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The FQDN or IP address (and optional port) of the remote node. If a port is not provided, it will vary based on the transport encoding: 55555 (plain-text), 55443 (encrypted), or 55003 (compressed).")
  ...
  public DmrClusterLinkRemoteAddress remoteNodeName(String remoteNodeName) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DmrClusterLinkRemoteAddress dmrClusterLinkRemoteAddress = (DmrClusterLinkRemoteAddress) o;
    return Objects.equals(this.dmrClusterName, dmrClusterLinkRemoteAddress.dmrClusterName) &&
        Objects.equals(this.remoteAddress, dmrClusterLinkRemoteAddress.remoteAddress) &&
        Objects.equals(this.remoteNodeName, dmrClusterLinkRemoteAddress.remoteNodeName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dmrClusterName, remoteAddress, remoteNodeName);
  }
  ...
  public String toString() {
    ...
    sb.append("class DmrClusterLinkRemoteAddress {\n");
