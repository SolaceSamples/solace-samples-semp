...
public class AboutUserMsgVpn {
  ...
  public AboutUserMsgVpn accessLevel(AccessLevelEnum accessLevel) {
   ...
   * @return accessLevel
  **/
  @ApiModelProperty(example = "null", value = "The Message VPN access level of the User. The allowed values and their meaning are:  <pre> \"none\" - No access. \"read-only\" - Read only access. \"read-write\" - Read and write access. </pre> ")
  ...
  public AboutUserMsgVpn msgVpnName(String msgVpnName) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AboutUserMsgVpn aboutUserMsgVpn = (AboutUserMsgVpn) o;
    return Objects.equals(this.accessLevel, aboutUserMsgVpn.accessLevel) &&
        Objects.equals(this.msgVpnName, aboutUserMsgVpn.msgVpnName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessLevel, msgVpnName);
  }
  ...
  public String toString() {
    ...
    sb.append("class AboutUserMsgVpn {\n");
