...
public class MsgVpnDmrBridge {
  ...
  public MsgVpnDmrBridge msgVpnName(String msgVpnName) {
  ...
  **/
  ...
  public MsgVpnDmrBridge remoteMsgVpnName(String remoteMsgVpnName) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The remote Message VPN of the DMR Bridge. The default is to have no `remoteMsgVpnName`.")
  ...
  public MsgVpnDmrBridge remoteNodeName(String remoteNodeName) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The name of the node at the remote end of the DMR Bridge.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnDmrBridge msgVpnDmrBridge = (MsgVpnDmrBridge) o;
    return Objects.equals(this.msgVpnName, msgVpnDmrBridge.msgVpnName) &&
        Objects.equals(this.remoteMsgVpnName, msgVpnDmrBridge.remoteMsgVpnName) &&
        Objects.equals(this.remoteNodeName, msgVpnDmrBridge.remoteNodeName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(msgVpnName, remoteMsgVpnName, remoteNodeName);
  }
  ...
  public String toString() {
    ...
    sb.append("class MsgVpnDmrBridge {\n");
