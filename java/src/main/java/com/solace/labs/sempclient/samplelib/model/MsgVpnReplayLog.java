...
public class MsgVpnReplayLog {
  ...
  @JsonProperty("replayLogName")
  private String replayLogName = null;

  public MsgVpnReplayLog egressEnabled(Boolean egressEnabled) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Enable or disable the transmission of messages from the Replay Log. The default value is `false`.")
  ...
  public MsgVpnReplayLog ingressEnabled(Boolean ingressEnabled) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Enable or disable the reception of messages to the Replay Log. The default value is `false`.")
  ...
  public MsgVpnReplayLog maxSpoolUsage(Long maxSpoolUsage) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The maximum spool usage allowed by the Replay Log, in megabytes (MB). If this limit is exceeded, old messages will be trimmed. The default value is `0`.")
  ...
  public MsgVpnReplayLog msgVpnName(String msgVpnName) {
  ...
  **/
  ...
  public MsgVpnReplayLog replayLogName(String replayLogName) {
   ...
   * @return replayLogName
  **/
  @ApiModelProperty(example = "null", value = "The name of the Replay Log.")
  public String getReplayLogName() {
    return replayLogName;
  }

  public void setReplayLogName(String replayLogName) {
    this.replayLogName = replayLogName;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnReplayLog msgVpnReplayLog = (MsgVpnReplayLog) o;
    return Objects.equals(this.egressEnabled, msgVpnReplayLog.egressEnabled) &&
        Objects.equals(this.ingressEnabled, msgVpnReplayLog.ingressEnabled) &&
        Objects.equals(this.maxSpoolUsage, msgVpnReplayLog.maxSpoolUsage) &&
        Objects.equals(this.msgVpnName, msgVpnReplayLog.msgVpnName) &&
        Objects.equals(this.replayLogName, msgVpnReplayLog.replayLogName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(egressEnabled, ingressEnabled, maxSpoolUsage, msgVpnName, replayLogName);
  }
  ...
  public String toString() {
    ...
    sb.append("class MsgVpnReplayLog {\n");
