...
public class MsgVpnAclProfileSubscribeException   {
  ...
  @SerializedName("subscribeExceptionTopic")
  private String subscribeExceptionTopic = null;

  /**
   * The syntax of the topic of the Subscribe Exception. The allowed values and their meaning are:      \"smf\" - Topic uses SMF syntax.     \"mqtt\" - Topic uses MQTT syntax. 
   */
  ...
  public MsgVpnAclProfileSubscribeException aclProfileName(String aclProfileName) {
  ...
  **/
  ...
  public MsgVpnAclProfileSubscribeException msgVpnName(String msgVpnName) {
  ...
  **/
  ...
  public MsgVpnAclProfileSubscribeException subscribeExceptionTopic(String subscribeExceptionTopic) {
    this.subscribeExceptionTopic = subscribeExceptionTopic;
    return this;
  }

   /**
   * The topic of the Subscribe Exception. May include syntax-appropriate wildcards.
   * @return subscribeExceptionTopic
  **/
  @ApiModelProperty(example = "null", value = "The topic of the Subscribe Exception. May include syntax-appropriate wildcards.")
  public String getSubscribeExceptionTopic() {
    return subscribeExceptionTopic;
  }

  public void setSubscribeExceptionTopic(String subscribeExceptionTopic) {
    this.subscribeExceptionTopic = subscribeExceptionTopic;
  }

  public MsgVpnAclProfileSubscribeException topicSyntax(TopicSyntaxEnum topicSyntax) {
   ...
   * @return topicSyntax
  **/
  @ApiModelProperty(example = "null", value = "The syntax of the topic of the Subscribe Exception. The allowed values and their meaning are:      \"smf\" - Topic uses SMF syntax.     \"mqtt\" - Topic uses MQTT syntax. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnAclProfileSubscribeException msgVpnAclProfileSubscribeException = (MsgVpnAclProfileSubscribeException) o;
    return Objects.equals(this.aclProfileName, msgVpnAclProfileSubscribeException.aclProfileName) &&
        Objects.equals(this.msgVpnName, msgVpnAclProfileSubscribeException.msgVpnName) &&
        Objects.equals(this.subscribeExceptionTopic, msgVpnAclProfileSubscribeException.subscribeExceptionTopic) &&
        Objects.equals(this.topicSyntax, msgVpnAclProfileSubscribeException.topicSyntax);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aclProfileName, msgVpnName, subscribeExceptionTopic, topicSyntax);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MsgVpnAclProfileSubscribeException {\n");
