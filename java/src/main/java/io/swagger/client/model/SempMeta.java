...
import io.swagger.client.model.SempPaging;
import io.swagger.client.model.SempRequest;
...
public class SempMeta   {
  ...
  private SempError error = null;

  @SerializedName("paging")
  private SempPaging paging = null;

  @SerializedName("request")
  private SempRequest request = null;

  @SerializedName("responseCode")
  private Integer responseCode = null;

  public SempMeta error(SempError error) {
    this.error = error;
    return this;
  }

   /**
   * The error object, present only when the request fails (`responseCode` is not 200).
   * @return error
  **/
  @ApiModelProperty(example = "null", value = "The error object, present only when the request fails (`responseCode` is not 200).")
  public SempError getError() {
    return error;
  }

  public void setError(SempError error) {
    this.error = error;
  }

  public SempMeta paging(SempPaging paging) {
    this.paging = paging;
    return this;
  }

   /**
   * The paging object, present only when the request was not completely satisfied.
   * @return paging
  **/
  @ApiModelProperty(example = "null", value = "The paging object, present only when the request was not completely satisfied.")
  public SempPaging getPaging() {
    return paging;
  }

  public void setPaging(SempPaging paging) {
    this.paging = paging;
  }

  public SempMeta request(SempRequest request) {
    this.request = request;
    return this;
  }

   /**
   * The request object, describing the request which generated this response.
   * @return request
  **/
  @ApiModelProperty(example = "null", required = true, value = "The request object, describing the request which generated this response.")
  public SempRequest getRequest() {
    return request;
  }

  public void setRequest(SempRequest request) {
    this.request = request;
  }

  public SempMeta responseCode(Integer responseCode) {
   ...
   * @return responseCode
  **/
  @ApiModelProperty(example = "null", required = true, value = "The HTTP response code, one of 200 (success), 4xx (client error), or 5xx (server error).")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SempMeta sempMeta = (SempMeta) o;
    return Objects.equals(this.error, sempMeta.error) &&
        Objects.equals(this.paging, sempMeta.paging) &&
        Objects.equals(this.request, sempMeta.request) &&
        Objects.equals(this.responseCode, sempMeta.responseCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(error, paging, request, responseCode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SempMeta {\n");
