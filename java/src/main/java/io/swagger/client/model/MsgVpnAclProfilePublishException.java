...
public class MsgVpnAclProfilePublishException   {
  ...
  @SerializedName("publishExceptionTopic")
  private String publishExceptionTopic = null;

  /**
   * The syntax of the topic of the Publish Exception. The allowed values and their meaning are:      \"smf\" - Topic uses SMF syntax.     \"mqtt\" - Topic uses MQTT syntax. 
   */
  public enum TopicSyntaxEnum {
    @SerializedName("smf")
    SMF("smf"),
  ...
  @SerializedName("topicSyntax")
  private TopicSyntaxEnum topicSyntax = null;

  public MsgVpnAclProfilePublishException aclProfileName(String aclProfileName) {
  ...
  **/
  ...
  public MsgVpnAclProfilePublishException msgVpnName(String msgVpnName) {
  ...
  **/
  ...
  public MsgVpnAclProfilePublishException publishExceptionTopic(String publishExceptionTopic) {
    this.publishExceptionTopic = publishExceptionTopic;
    return this;
  }

   /**
   * The topic of the Publish Exception. May include syntax-appropriate wildcards.
   * @return publishExceptionTopic
  **/
  @ApiModelProperty(example = "null", value = "The topic of the Publish Exception. May include syntax-appropriate wildcards.")
  public String getPublishExceptionTopic() {
    return publishExceptionTopic;
  }

  public void setPublishExceptionTopic(String publishExceptionTopic) {
    this.publishExceptionTopic = publishExceptionTopic;
  }

  public MsgVpnAclProfilePublishException topicSyntax(TopicSyntaxEnum topicSyntax) {
    this.topicSyntax = topicSyntax;
    return this;
  }
   ...
   * @return topicSyntax
  **/
  @ApiModelProperty(example = "null", value = "The syntax of the topic of the Publish Exception. The allowed values and their meaning are:      \"smf\" - Topic uses SMF syntax.     \"mqtt\" - Topic uses MQTT syntax. ")
  public TopicSyntaxEnum getTopicSyntax() {
    return topicSyntax;
  }

  public void setTopicSyntax(TopicSyntaxEnum topicSyntax) {
    this.topicSyntax = topicSyntax;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnAclProfilePublishException msgVpnAclProfilePublishException = (MsgVpnAclProfilePublishException) o;
    return Objects.equals(this.aclProfileName, msgVpnAclProfilePublishException.aclProfileName) &&
        Objects.equals(this.msgVpnName, msgVpnAclProfilePublishException.msgVpnName) &&
        Objects.equals(this.publishExceptionTopic, msgVpnAclProfilePublishException.publishExceptionTopic) &&
        Objects.equals(this.topicSyntax, msgVpnAclProfilePublishException.topicSyntax);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aclProfileName, msgVpnName, publishExceptionTopic, topicSyntax);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MsgVpnAclProfilePublishException {\n");
