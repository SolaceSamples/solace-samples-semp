...
public class EventThreshold   {
  @SerializedName("clearPercent")
  private Integer clearPercent = null;

  @SerializedName("clearValue")
  private Integer clearValue = null;

  @SerializedName("setPercent")
  private Integer setPercent = null;

  @SerializedName("setValue")
  private Integer setValue = null;

  public EventThreshold clearPercent(Integer clearPercent) {
    this.clearPercent = clearPercent;
    return this;
  }

   /**
   * Threshold clear percent.
   * @return clearPercent
  **/
  @ApiModelProperty(example = "null", value = "Threshold clear percent.")
  public Integer getClearPercent() {
    return clearPercent;
  }

  public void setClearPercent(Integer clearPercent) {
    this.clearPercent = clearPercent;
  }

  public EventThreshold clearValue(Integer clearValue) {
   ...
   * @return clearValue
  **/
  @ApiModelProperty(example = "null", value = "Threshold clear value.")
  ...
  public EventThreshold setPercent(Integer setPercent) {
    this.setPercent = setPercent;
    return this;
  }

   /**
   * Threshold set percent.
   * @return setPercent
  **/
  @ApiModelProperty(example = "null", value = "Threshold set percent.")
  public Integer getSetPercent() {
    return setPercent;
  }

  public void setSetPercent(Integer setPercent) {
    this.setPercent = setPercent;
  }

  public EventThreshold setValue(Integer setValue) {
   ...
   * @return setValue
  **/
  @ApiModelProperty(example = "null", value = "Threshold set value.")
