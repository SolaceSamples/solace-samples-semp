...
public class MsgVpnSequencedTopic   {
  ...
  @SerializedName("sequencedTopic")
  private String sequencedTopic = null;

  public MsgVpnSequencedTopic msgVpnName(String msgVpnName) {
  ...
  **/
  ...
  public MsgVpnSequencedTopic sequencedTopic(String sequencedTopic) {
    this.sequencedTopic = sequencedTopic;
    return this;
  }

   /**
   * Topic for applying sequence numbers.
   * @return sequencedTopic
  **/
  @ApiModelProperty(example = "null", value = "Topic for applying sequence numbers.")
  public String getSequencedTopic() {
    return sequencedTopic;
  }

  public void setSequencedTopic(String sequencedTopic) {
    this.sequencedTopic = sequencedTopic;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnSequencedTopic msgVpnSequencedTopic = (MsgVpnSequencedTopic) o;
    return Objects.equals(this.msgVpnName, msgVpnSequencedTopic.msgVpnName) &&
        Objects.equals(this.sequencedTopic, msgVpnSequencedTopic.sequencedTopic);
  }

  @Override
  public int hashCode() {
    return Objects.hash(msgVpnName, sequencedTopic);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MsgVpnSequencedTopic {\n");
