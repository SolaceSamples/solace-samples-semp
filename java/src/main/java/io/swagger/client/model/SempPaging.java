...
public class SempPaging   {
  @SerializedName("cursorQuery")
  private String cursorQuery = null;

  @SerializedName("nextPageUri")
  private String nextPageUri = null;

  public SempPaging cursorQuery(String cursorQuery) {
   ...
   * @return cursorQuery
  **/
  @ApiModelProperty(example = "null", required = true, value = "The cursor, or position, for the next page of objects. Use this as the `cursor` query parameter of the next request.")
  public String getCursorQuery() {
    return cursorQuery;
  }

  public void setCursorQuery(String cursorQuery) {
    this.cursorQuery = cursorQuery;
  }

  public SempPaging nextPageUri(String nextPageUri) {
   ...
   * @return nextPageUri
  **/
  @ApiModelProperty(example = "null", required = true, value = "The URI of the next page of objects. `cursorQuery` is already embedded within this URI.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SempPaging sempPaging = (SempPaging) o;
    return Objects.equals(this.cursorQuery, sempPaging.cursorQuery) &&
        Objects.equals(this.nextPageUri, sempPaging.nextPageUri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cursorQuery, nextPageUri);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SempPaging {\n");
