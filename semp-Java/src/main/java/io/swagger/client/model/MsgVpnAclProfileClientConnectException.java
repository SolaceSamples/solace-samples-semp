...
public class MsgVpnAclProfileClientConnectException   {
  @SerializedName("aclProfileName")
  private String aclProfileName = null;

  @SerializedName("clientConnectExceptionAddress")
  private String clientConnectExceptionAddress = null;

  @SerializedName("msgVpnName")
  private String msgVpnName = null;

  public MsgVpnAclProfileClientConnectException aclProfileName(String aclProfileName) {
  ...
  **/
  ...
  public MsgVpnAclProfileClientConnectException clientConnectExceptionAddress(String clientConnectExceptionAddress) {
    this.clientConnectExceptionAddress = clientConnectExceptionAddress;
    return this;
  }

   /**
   * The IP address/Netmask in CIDR form of the Client Connect Exception.
   * @return clientConnectExceptionAddress
  **/
  @ApiModelProperty(example = "null", value = "The IP address/Netmask in CIDR form of the Client Connect Exception.")
  public String getClientConnectExceptionAddress() {
    return clientConnectExceptionAddress;
  }

  public void setClientConnectExceptionAddress(String clientConnectExceptionAddress) {
    this.clientConnectExceptionAddress = clientConnectExceptionAddress;
  }

  public MsgVpnAclProfileClientConnectException msgVpnName(String msgVpnName) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnAclProfileClientConnectException msgVpnAclProfileClientConnectException = (MsgVpnAclProfileClientConnectException) o;
    return Objects.equals(this.aclProfileName, msgVpnAclProfileClientConnectException.aclProfileName) &&
        Objects.equals(this.clientConnectExceptionAddress, msgVpnAclProfileClientConnectException.clientConnectExceptionAddress) &&
        Objects.equals(this.msgVpnName, msgVpnAclProfileClientConnectException.msgVpnName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aclProfileName, clientConnectExceptionAddress, msgVpnName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MsgVpnAclProfileClientConnectException {\n");
