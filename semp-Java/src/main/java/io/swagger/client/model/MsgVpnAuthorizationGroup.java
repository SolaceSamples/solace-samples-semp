...
public class MsgVpnAuthorizationGroup   {
  ...
  @SerializedName("orderAfterAuthorizationGroupName")
  private String orderAfterAuthorizationGroupName = null;

  @SerializedName("orderBeforeAuthorizationGroupName")
  private String orderBeforeAuthorizationGroupName = null;

  public MsgVpnAuthorizationGroup aclProfileName(String aclProfileName) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The ACL Profile of the LDAP Authorization Group. The default value is `\"default\"`.")
  ...
  public MsgVpnAuthorizationGroup authorizationGroupName(String authorizationGroupName) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The name of the LDAP Authorization Group.")
  ...
  public MsgVpnAuthorizationGroup clientProfileName(String clientProfileName) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The Client Profile of the LDAP Authorization Group. The default value is `\"default\"`.")
  ...
  public MsgVpnAuthorizationGroup enabled(Boolean enabled) {
   ...
   * @return enabled
  **/
  @ApiModelProperty(example = "null", value = "Enable or disable the authorization feature for this group for the Message VPN. The default value is `false`.")
  ...
  public MsgVpnAuthorizationGroup msgVpnName(String msgVpnName) {
  ...
  **/
  ...
  public MsgVpnAuthorizationGroup orderAfterAuthorizationGroupName(String orderAfterAuthorizationGroupName) {
    this.orderAfterAuthorizationGroupName = orderAfterAuthorizationGroupName;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "Lower the priority to be less than this group. The default is not applicable.")
  public String getOrderAfterAuthorizationGroupName() {
    return orderAfterAuthorizationGroupName;
  }

  public void setOrderAfterAuthorizationGroupName(String orderAfterAuthorizationGroupName) {
    this.orderAfterAuthorizationGroupName = orderAfterAuthorizationGroupName;
  }

  public MsgVpnAuthorizationGroup orderBeforeAuthorizationGroupName(String orderBeforeAuthorizationGroupName) {
    this.orderBeforeAuthorizationGroupName = orderBeforeAuthorizationGroupName;
    return this;
  }

   /**
   * Raise the priority to be greater than this group. The default is not applicable.
   * @return orderBeforeAuthorizationGroupName
  **/
  @ApiModelProperty(example = "null", value = "Raise the priority to be greater than this group. The default is not applicable.")
  public String getOrderBeforeAuthorizationGroupName() {
    return orderBeforeAuthorizationGroupName;
  }

  public void setOrderBeforeAuthorizationGroupName(String orderBeforeAuthorizationGroupName) {
    this.orderBeforeAuthorizationGroupName = orderBeforeAuthorizationGroupName;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnAuthorizationGroup msgVpnAuthorizationGroup = (MsgVpnAuthorizationGroup) o;
    return Objects.equals(this.aclProfileName, msgVpnAuthorizationGroup.aclProfileName) &&
        Objects.equals(this.authorizationGroupName, msgVpnAuthorizationGroup.authorizationGroupName) &&
        Objects.equals(this.clientProfileName, msgVpnAuthorizationGroup.clientProfileName) &&
        Objects.equals(this.enabled, msgVpnAuthorizationGroup.enabled) &&
        Objects.equals(this.msgVpnName, msgVpnAuthorizationGroup.msgVpnName) &&
        Objects.equals(this.orderAfterAuthorizationGroupName, msgVpnAuthorizationGroup.orderAfterAuthorizationGroupName) &&
        Objects.equals(this.orderBeforeAuthorizationGroupName, msgVpnAuthorizationGroup.orderBeforeAuthorizationGroupName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aclProfileName, authorizationGroupName, clientProfileName, enabled, msgVpnName, orderAfterAuthorizationGroupName, orderBeforeAuthorizationGroupName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MsgVpnAuthorizationGroup {\n");
